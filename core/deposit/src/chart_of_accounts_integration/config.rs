...
pub struct ChartOfAccountsIntegrationConfig {
    ...
    #[serde(alias = "chart_of_account_private_company_deposit_accounts_parent_code")]
    pub chart_of_accounts_private_company_deposit_accounts_parent_code: AccountCode,
    #[serde(alias = "chart_of_account_bank_deposit_accounts_parent_code")]
    pub chart_of_accounts_bank_deposit_accounts_parent_code: AccountCode,
    #[serde(alias = "chart_of_account_financial_institution_deposit_accounts_parent_code")]
    pub chart_of_accounts_financial_institution_deposit_accounts_parent_code: AccountCode,
    #[serde(alias = "chart_of_account_non_domiciled_company_deposit_accounts_parent_code")]
    ...
    #[serde(alias = "chart_of_account_frozen_private_company_deposit_accounts_parent_code")]
    pub chart_of_accounts_frozen_private_company_deposit_accounts_parent_code: AccountCode,
    #[serde(alias = "chart_of_account_frozen_bank_deposit_accounts_parent_code")]
    pub chart_of_accounts_frozen_bank_deposit_accounts_parent_code: AccountCode,
    #[serde(alias = "chart_of_account_frozen_financial_institution_deposit_accounts_parent_code")]
    pub chart_of_accounts_frozen_financial_institution_deposit_accounts_parent_code: AccountCode,
    #[serde(alias = "chart_of_account_frozen_non_domiciled_company_deposit_accounts_parent_code")]
