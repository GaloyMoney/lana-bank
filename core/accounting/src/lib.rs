    ...
    <<Perms as PermissionCheck>::Audit as AuditSvc>::Object: From<CoreAccountingObject>,
{
    ...
    #[instrument(
        name = "core_accounting.find_ledger_account_by_id",
        skip(self),
        fields(error.level)
    )]
    ...
    #[record_error_severity]
    #[instrument(
        name = "core_accounting.find_ledger_account_by_code",
        skip(self),
        fields(error.level)
    )]
    ...
    #[record_error_severity]
    #[instrument(
        name = "core_accounting.find_all_ledger_accounts",
        skip(self),
        fields(error.level)
    )]
    ...
    #[record_error_severity]
    #[instrument(
        name = "core_accounting.list_all_account_flattened",
        skip(self),
        fields(error.level)
    )]
    ...
    #[record_error_severity]
    #[instrument(name = "core_accounting.import_csv", skip(self), fields(error.level))]
    ...
    #[record_error_severity]
    #[instrument(
        name = "core_accounting.init_fiscal_year_for_chart",
        skip(self),
        fields(error.level)
    )]
    ...
    #[record_error_severity]
    #[instrument(
        name = "core_accounting.list_fiscal_years_for_chart",
        skip(self),
        fields(error.level)
    )]
    ...
    #[record_error_severity]
    #[instrument(
        name = "core_accounting.add_root_node",
        skip(self),
        fields(error.level)
    )]
    ...
    #[record_error_severity]
    #[instrument(
        name = "core_accounting.add_child_node",
        skip(self),
        fields(error.level)
    )]
