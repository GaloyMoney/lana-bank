...
// Account Sets
pub(super) const LOANS_DISBURSED_RECEIVABLE_CONTROL_ACCOUNT_SET_ID: Uuid =
...
pub(super) const OBS_LOANS_FACILITY_CONTROL_ACCOUNT_SET_ID: Uuid =
...
pub(super) const OBS_LOANS_FACILITY_ACCOUNT_CODE: &str = "BANK.LOANS_FACILITY.OMNIBUS";
...
pub(super) const APPROVE_LOAN_FACILITY_CODE: &str = "APPROVE_LOAN_FACILITY";
pub(super) const LOAN_DISBURSEMENT_CODE: &str = "LOAN_DISBURSEMENT";
