    ...
    fn from(repayment: crate::loan::LoanRepaymentInPlan) -> Self {
        match repayment {
            crate::loan::LoanRepaymentInPlan::Interest(interest) => LoanRepaymentInPlan {
                ...
                due_amount: match interest.status {
                    crate::loan::RepaymentStatus::Due(amount)
                    | crate::loan::RepaymentStatus::Overdue(amount) => amount,
                    _ => UsdCents::ZERO,
                },
            },
...
impl From<crate::loan::RepaymentStatus> for LoanRepaymentStatus {
    fn from(status: crate::loan::RepaymentStatus) -> Self {
        match status {
            ...
            crate::loan::RepaymentStatus::Due(_) => LoanRepaymentStatus::Due,
            crate::loan::RepaymentStatus::Overdue(_) => LoanRepaymentStatus::Overdue,
