        ...
        + OutboxEventMarker<CoreCustomerEvent>,
{
    ...
    pub async fn subject_can_record_collateral_sent(
        &self,
        sub: &<<Perms as PermissionCheck>::Audit as AuditSvc>::Subject,
    ...
    #[record_error_severity]
    #[instrument(name = "credit.record_collateral_sent", skip(self, sub), err)]
    pub async fn record_collateral_sent(
        ...
        self.subject_can_record_collateral_sent(sub, liquidation_id, true)
            .await?
            .expect("audit info missing");
