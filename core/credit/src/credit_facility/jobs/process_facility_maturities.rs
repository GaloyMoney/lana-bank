...
pub struct ProcessFacilityMaturitiesJobConfig {
...
{
    type Config = ProcessFacilityMaturitiesJobConfig;
...
where
    E: OutboxEventMarker<CoreCreditEvent>
        ...
        + OutboxEventMarker<CorePriceEvent>,
{
    config: ProcessFacilityMaturitiesJobConfig,
    repo: Arc<CreditFacilityRepo<E>>,
    maturity_spawner: CreditFacilityMaturityJobSpawner,
}
...
pub type ProcessFacilityMaturitiesJobSpawner = JobSpawner<ProcessFacilityMaturitiesJobConfig>;
