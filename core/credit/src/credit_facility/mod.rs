...
pub use entity::{CreditFacility, FacilityCollateralization, LiquidationTrigger};
        ...
        + OutboxEventMarker<CorePriceEvent>,
{
        ...
        E: OutboxEventMarker<core_time_events::CoreTimeEvent>,
    {
        ...
        let update_collateralization_from_price_spawner = jobs.add_initializer(
            jobs::update_collateralization_from_price::UpdateCollateralizationFromPriceJobInitializer::<Perms, E>::new(
                repo.clone(),
                collaterals.clone(),
                ledger.clone(),
                authz.clone(),
