...
pub const PERMISSION_SET_CREDIT_PAYMENT_DATE_WRITER: &str = "credit_payment_date_writer";
...
impl ActionPermission for ObligationAction {
    fn permission_set(&self) -> &'static str {
        match self {
            ...
            Self::RecordAllocationWithDate => PERMISSION_SET_CREDIT_PAYMENT_DATE_WRITER,
        }
    }
}
