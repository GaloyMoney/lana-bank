        ...
        + OutboxEventMarker<CorePriceEvent>,
{
    pub async fn init(
        ...
        spawner.spawn_unique(job_new::JobId::new(), jobs::collateralization_from_events_for_pending_facility::PendingCreditFacilityCollateralizationFromEventsJobConfig::<E>{
