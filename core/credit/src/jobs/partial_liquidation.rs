...
use crate::{
    CoreCreditAction, CoreCreditEvent, CoreCreditObject, CreditFacilities, CreditFacilityId,
    ...
    async fn process_message(
        ...
        match &message.as_event() {
            Some(
                ...
                let payment_created = self.payments.record_in_op(db, new_payment).await?;
