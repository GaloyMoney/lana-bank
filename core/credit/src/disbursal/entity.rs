    ...
    fn settle_disbursal(
        ...
        Idempotent::Executed(
            NewObligation::builder()
                ...
                .due_date(EffectiveDate::from(self.due_date))
                .overdue_date(self.overdue_date.map(EffectiveDate::from))
                .liquidation_date(self.liquidation_date.map(EffectiveDate::from))
                .effective(effective)
