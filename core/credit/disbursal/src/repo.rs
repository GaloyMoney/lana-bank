...
use crate::{
    entity::*, error::DisbursalError, event::CoreCreditDisbursalEvent, primitives::*,
    publisher::DisbursalPublisher,
};
...
where
    E: OutboxEventMarker<CoreCreditDisbursalEvent>,
{
    pub fn new(pool: &PgPool, publisher: &DisbursalPublisher<E>, clock: ClockHandle) -> Self {
        Self {
            pool: pool.clone(),
