...
impl Disbursal {
    ...
    pub(crate) fn is_approved(&self) -> Option<bool> {
...
pub struct NewDisbursal {
    #[builder(setter(into))]
    pub(crate) id: DisbursalId,
    #[builder(setter(into))]
    pub(crate) approval_process_id: ApprovalProcessId,
    #[builder(setter(into))]
    pub(crate) beneficiary_id: BeneficiaryId,
    pub(crate) amount: UsdCents,
    pub(crate) account_ids: DisbursalLedgerAccountIds,
    #[builder(setter(into))]
    pub(crate) disbursal_credit_account_id: CalaAccountId,
