...
#[graphql(
    ...
    query_path = "src/graphql/build_info.graphql",
...
#[graphql(
    schema_path = "../../lana/admin-server/src/graphql/schema.graphql",
    query_path = "src/graphql/role.graphql",
    response_derives = "Debug, Clone, Serialize"
)]
...
pub struct RoleAddPermissionSets;
...
pub struct RoleRemovePermissionSets;
