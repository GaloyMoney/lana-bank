...
impl GraphQLClient {
    pub fn new(admin_url: String, auth: AuthClient, graphql_debug_level: u8) -> Self {
        ...
        Q::ResponseData: DeserializeOwned,
    {
        ...
        self.debug_print_operation(body.operation_name, body.query, &body.variables, None);
    ...
    fn debug_print_operation<V: serde::Serialize>(
        &self,
        operation_name: &str,
        query: &str,
        variables: &V,
    ...
    fn debug_print_multipart_operation(&self, operations: &Value, uploads: &[MultipartUpload]) {
        ...
        self.debug_print_operation(operation_name, query, &variables, Some(uploads));
    }
}
...
fn extract_operation_block(document: &str, operation_name: &str) -> String {
