...
def generate_single_report(
    fetch_table: Callable[[str, str | None, bool], tuple[list[str], list[dict[str, Any]]]],
    ...
    Args:
        fetch_table: Function to fetch table data. Takes (table_name, as_of_date, supports_as_of), returns (field_names, records).
    ...
    field_names, records = fetch_table(table_name, as_of_date, supports_as_of)
