with
    ...
    titles as (
        ...
        select
            ...
            []
        union all
        select 600, '    A Costo amortizado', '    At amortized cost', []
        union all
        select
            700,
        ...
        select
            ...
            []
        union all
        select 1200, '    Créditos vencidos', '    Overdue credits', []
        union all
        select
            1300,
        ...
        select
            ...
            ['121', '123', '121']
        union all
        select 2000, 'Total Activos', 'Total Assets', []
        union all
        select 2100, 'PASIVO', 'PASSIVE', []
        union all
        select
            2200,
        ...
        select
            ...
            ['212002', '212005']
        union all
        select 3600, 'Obligaciones a la vista (213)', 'Demand bonds (213)', ['213']
        union all
        select
            3700,
            ...
            ['222', '223']
        union all
        select 3800, 'Provisiones (2240)', 'Provisions (2240)', ['2240']
        union all
        select
            3900,
        ...
        union all
        select
            4000, 'Préstamos subordinados (2119)', 'Subordinated loans (2119)', ['2119']
        union all
        select 4100, 'Total Pasivos', 'Total Liabilities', []
        union all
        select 4200, 'PATRIMONIO NETO', 'NET WORTH', []
        union all
        select 4300, 'Capital Social (311)4/', 'Share Capital (311) 4/', ['311']
        union all
        select 4400, 'Reservas (313)', 'Reservations (313)', ['313']
        union all
        select 4500, '    De capital', '    From capital', []
        union all
        select 4600, '    Otras reservas', '    Other reservations', []
        union all
        select
            4700, 'Resultados por aplicar (314)', 'Results to be applied (314)', ['314']
        union all
        select
            4800,
        ...
        select
            ...
            []
        union all
        select 5000, 'Primas sobre acciones (315)', 'Share premiums (315)', ['315']
        union all
        select 5100, 'Patrimonio restringido', 'Restricted assets', []
        union all
        select
            5200,
            ...
            ['321']
        union all
        select 5300, '    Donaciones (322)', '    Donations (322)', ['322']
        union all
        select
            5400,
        ...
        select
            ...
            []
        union all
        select 5700, 'Participaciones no controladoras', 'Non-controlling interests', []
        union all
        select 5800, 'Total patrimonio', 'Total assets', []
        union all
        select 5900, 'Total Pasivo y Patrimonio', 'Total Liabilities and Equity', []
