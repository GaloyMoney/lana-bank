with
    ...
    titles as (
        ...
        union all
        select 200, 'Efecto de las correcciones de errores', 'Effect of bug fixes', []
        union all
        select
            300,
            ...
            []
        union all
        select 400, 'Balance re-expresado', 'Restated balance sheet', []
        union all
        select 500, 'Emisión de acciones', 'Issuance of shares', []
        union all
        select 600, 'Dividendos', 'Dividends', []
        union all
        select 700, 'Otro Resultado Integral:', 'Other Comprehensive Income:', []
        union all
        select
            800,
        ...
        union all
        select
            1100, 'Reclasificaciones a resultados', 'Reclassifications to results', []
        union all
        select
            1200,
