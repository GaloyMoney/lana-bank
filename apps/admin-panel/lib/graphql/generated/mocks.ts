...
export const mockBitfinexConfig = (overrides?: Partial<BitfinexConfig>, _relationshipsToOmit: Set<string> = new Set()): BitfinexConfig => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('BitfinexConfig');
    return {
...
export const mockCustodianConfigInput = (override?: CustodianConfigInput, _relationshipsToOmit: Set<string> = new Set()): CustodianConfigInput => {
    ...
    return {
        ...(override ? override : {bitfinex : relationshipsToOmit.has('BitfinexConfig') ? {} as BitfinexConfig : mockBitfinexConfig({}, relationshipsToOmit)}),
    };
};
