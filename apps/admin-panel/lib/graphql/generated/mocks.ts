...
export const mockAgent = (overrides?: Partial<Agent>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Agent' } & Agent => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('Agent');
    return {
        __typename: 'Agent',
        agentId: overrides && overrides.hasOwnProperty('agentId') ? overrides.agentId! : generateMockValue.uuid(),
        createdAt: overrides && overrides.hasOwnProperty('createdAt') ? overrides.createdAt! : generateMockValue.timestamp(),
        description: overrides && overrides.hasOwnProperty('description') ? overrides.description! : generateMockValue.description(),
        id: overrides && overrides.hasOwnProperty('id') ? overrides.id! : faker.string.uuid(),
        keycloakClientId: overrides && overrides.hasOwnProperty('keycloakClientId') ? overrides.keycloakClientId! : faker.lorem.word(),
        name: overrides && overrides.hasOwnProperty('name') ? overrides.name! : generateMockValue.name(),
        status: overrides && overrides.hasOwnProperty('status') ? overrides.status! : AgentStatus.Active,
    };
};

export const mockAgentConnection = (overrides?: Partial<AgentConnection>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'AgentConnection' } & AgentConnection => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('AgentConnection');
    return {
        __typename: 'AgentConnection',
        edges: overrides && overrides.hasOwnProperty('edges') ? overrides.edges! : [relationshipsToOmit.has('AgentEdge') ? {} as AgentEdge : mockAgentEdge({}, relationshipsToOmit)],
        nodes: overrides && overrides.hasOwnProperty('nodes') ? overrides.nodes! : [relationshipsToOmit.has('Agent') ? {} as Agent : mockAgent({}, relationshipsToOmit)],
...
export const mockAgentCreateInput = (overrides?: Partial<AgentCreateInput>, _relationshipsToOmit: Set<string> = new Set()): AgentCreateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('AgentCreateInput');
    return {
        description: overrides && overrides.hasOwnProperty('description') ? overrides.description! : generateMockValue.description(),
        name: overrides && overrides.hasOwnProperty('name') ? overrides.name! : generateMockValue.name(),
    };
...
export const mockAgentCreatePayload = (overrides?: Partial<AgentCreatePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'AgentCreatePayload' } & AgentCreatePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('AgentCreatePayload');
    return {
        __typename: 'AgentCreatePayload',
        agent: overrides && overrides.hasOwnProperty('agent') ? overrides.agent! : relationshipsToOmit.has('Agent') ? {} as Agent : mockAgent({}, relationshipsToOmit),
        clientId: overrides && overrides.hasOwnProperty('clientId') ? overrides.clientId! : faker.lorem.word(),
        clientSecret: overrides && overrides.hasOwnProperty('clientSecret') ? overrides.clientSecret! : faker.lorem.word(),
    };
};

export const mockAgentDeactivateInput = (overrides?: Partial<AgentDeactivateInput>, _relationshipsToOmit: Set<string> = new Set()): AgentDeactivateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('AgentDeactivateInput');
    return {
        agentId: overrides && overrides.hasOwnProperty('agentId') ? overrides.agentId! : generateMockValue.uuid(),
    };
};

export const mockAgentDeactivatePayload = (overrides?: Partial<AgentDeactivatePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'AgentDeactivatePayload' } & AgentDeactivatePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('AgentDeactivatePayload');
    return {
...
export const mockAgentEdge = (overrides?: Partial<AgentEdge>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'AgentEdge' } & AgentEdge => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('AgentEdge');
    return {
        __typename: 'AgentEdge',
        cursor: overrides && overrides.hasOwnProperty('cursor') ? overrides.cursor! : generateMockValue.cursor(),
        node: overrides && overrides.hasOwnProperty('node') ? overrides.node! : relationshipsToOmit.has('Agent') ? {} as Agent : mockAgent({}, relationshipsToOmit),
    };
};

export const mockAgentsSort = (overrides?: Partial<AgentsSort>, _relationshipsToOmit: Set<string> = new Set()): AgentsSort => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('AgentsSort');
    return {
        by: overrides && overrides.hasOwnProperty('by') ? overrides.by! : AgentSortBy.CreatedAt,
...
export const mockAuditEntry = (overrides?: Partial<AuditEntry>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'AuditEntry' } & AuditEntry => {
    ...
    return {
        ...
        subject: overrides && overrides.hasOwnProperty('subject') ? overrides.subject! : relationshipsToOmit.has('Agent') ? {} as Agent : mockAgent({}, relationshipsToOmit),
    };
};
...
export const mockManualPriceCreateInput = (overrides?: Partial<ManualPriceCreateInput>, _relationshipsToOmit: Set<string> = new Set()): ManualPriceCreateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ManualPriceCreateInput');
    return {
        name: overrides && overrides.hasOwnProperty('name') ? overrides.name! : generateMockValue.name(),
        usdCentsPerBtc: overrides && overrides.hasOwnProperty('usdCentsPerBtc') ? overrides.usdCentsPerBtc! : faker.number.int({ min: 0, max: 9999 }),
    };
...
export const mockMutation = (overrides?: Partial<Mutation>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Mutation' } & Mutation => {
    ...
    return {
        ...
        agentCreate: overrides && overrides.hasOwnProperty('agentCreate') ? overrides.agentCreate! : relationshipsToOmit.has('AgentCreatePayload') ? {} as AgentCreatePayload : mockAgentCreatePayload({}, relationshipsToOmit),
        agentDeactivate: overrides && overrides.hasOwnProperty('agentDeactivate') ? overrides.agentDeactivate! : relationshipsToOmit.has('AgentDeactivatePayload') ? {} as AgentDeactivatePayload : mockAgentDeactivatePayload({}, relationshipsToOmit),
        ...
        priceProviderCreate: overrides && overrides.hasOwnProperty('priceProviderCreate') ? overrides.priceProviderCreate! : relationshipsToOmit.has('PriceProviderCreatePayload') ? {} as PriceProviderCreatePayload : mockPriceProviderCreatePayload({}, relationshipsToOmit),
...
export const mockPriceProviderCreateInput = (override?: PriceProviderCreateInput, _relationshipsToOmit: Set<string> = new Set()): PriceProviderCreateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PriceProviderCreateInput');
    return {
        ...(override ? override : {bitfinex : relationshipsToOmit.has('BitfinexCreateInput') ? {} as BitfinexCreateInput : mockBitfinexCreateInput({}, relationshipsToOmit)}),
    };
};

export const mockPriceProviderCreatePayload = (overrides?: Partial<PriceProviderCreatePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'PriceProviderCreatePayload' } & PriceProviderCreatePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PriceProviderCreatePayload');
    return {
...
export const mockProspectKycUpdatedPayload = (overrides?: Partial<ProspectKycUpdatedPayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'ProspectKycUpdatedPayload' } & ProspectKycUpdatedPayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ProspectKycUpdatedPayload');
    return {
...
export const mockQuery = (overrides?: Partial<Query>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Query' } & Query => {
    ...
    return {
        ...
        agent: overrides && overrides.hasOwnProperty('agent') ? overrides.agent! : relationshipsToOmit.has('Agent') ? {} as Agent : mockAgent({}, relationshipsToOmit),
        agents: overrides && overrides.hasOwnProperty('agents') ? overrides.agents! : relationshipsToOmit.has('AgentConnection') ? {} as AgentConnection : mockAgentConnection({}, relationshipsToOmit),
...
export const mockSubscription = (overrides?: Partial<Subscription>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Subscription' } & Subscription => {
    ...
    return {
        ...
        disbursalApprovalConcluded: overrides && overrides.hasOwnProperty('disbursalApprovalConcluded') ? overrides.disbursalApprovalConcluded! : relationshipsToOmit.has('DisbursalApprovalConcludedPayload') ? {} as DisbursalApprovalConcludedPayload : mockDisbursalApprovalConcludedPayload({}, relationshipsToOmit),
        ...
        prospectKycUpdated: overrides && overrides.hasOwnProperty('prospectKycUpdated') ? overrides.prospectKycUpdated! : relationshipsToOmit.has('ProspectKycUpdatedPayload') ? {} as ProspectKycUpdatedPayload : mockProspectKycUpdatedPayload({}, relationshipsToOmit),
        ...
        withdrawalApprovalConcluded: overrides && overrides.hasOwnProperty('withdrawalApprovalConcluded') ? overrides.withdrawalApprovalConcluded! : relationshipsToOmit.has('WithdrawalApprovalConcludedPayload') ? {} as WithdrawalApprovalConcludedPayload : mockWithdrawalApprovalConcludedPayload({}, relationshipsToOmit),
    };
};
...
export const mockTriggerReportRunInput = (overrides?: Partial<TriggerReportRunInput>, _relationshipsToOmit: Set<string> = new Set()): TriggerReportRunInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('TriggerReportRunInput');
    return {
...
export const mockWithdrawalApprovalConcludedPayload = (overrides?: Partial<WithdrawalApprovalConcludedPayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'WithdrawalApprovalConcludedPayload' } & WithdrawalApprovalConcludedPayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('WithdrawalApprovalConcludedPayload');
    return {
        __typename: 'WithdrawalApprovalConcludedPayload',
