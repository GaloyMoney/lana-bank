...
export const mockCreditFacility = (overrides?: Partial<CreditFacility>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CreditFacility' } & CreditFacility => {
    ...
    return {
        ...
        currentCvl: overrides && overrides.hasOwnProperty('currentCvl') ? overrides.currentCvl! : relationshipsToOmit.has('Cvlpct') ? {} as Cvlpct : mockCvlpct({}, relationshipsToOmit),
...
export const mockCvlpct = (overrides?: Partial<Cvlpct>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Cvlpct' } & Cvlpct => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('Cvlpct');
    return {
        __typename: 'Cvlpct',
        kind: overrides && overrides.hasOwnProperty('kind') ? overrides.kind! : Kind.Finite,
