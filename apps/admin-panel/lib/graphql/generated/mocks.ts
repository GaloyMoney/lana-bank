...
export const mockQuery = (overrides?: Partial<Query>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Query' } & Query => {
    ...
    return {
        ...
        transactionTemplates: overrides && overrides.hasOwnProperty('transactionTemplates') ? overrides.transactionTemplates! : [relationshipsToOmit.has('TransactionTemplate') ? {} as TransactionTemplate : mockTransactionTemplate({}, relationshipsToOmit)],
