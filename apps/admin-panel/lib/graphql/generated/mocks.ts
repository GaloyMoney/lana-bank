...
export const mockLiquidationsFilter = (overrides?: Partial<LiquidationsFilter>, _relationshipsToOmit: Set<string> = new Set()): LiquidationsFilter => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('LiquidationsFilter');
    return {
        completed: overrides && overrides.hasOwnProperty('completed') ? overrides.completed! : faker.datatype.boolean(),
    };
};
