...
export const mockChartOfAccountsAddNodeInput = (overrides?: Partial<ChartOfAccountsAddNodeInput>, _relationshipsToOmit: Set<string> = new Set()): ChartOfAccountsAddNodeInput => {
    ...
    return {
        chartId: overrides && overrides.hasOwnProperty('chartId') ? overrides.chartId! : generateMockValue.uuid(),
        proposedSpec: overrides && overrides.hasOwnProperty('proposedSpec') ? overrides.proposedSpec! : relationshipsToOmit.has('ChartOfAccountsProposedSpecInput') ? {} as ChartOfAccountsProposedSpecInput : mockChartOfAccountsProposedSpecInput({}, relationshipsToOmit),
    };
};
...
export const mockChartOfAccountsProposedSpecInput = (overrides?: Partial<ChartOfAccountsProposedSpecInput>, _relationshipsToOmit: Set<string> = new Set()): ChartOfAccountsProposedSpecInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ChartOfAccountsProposedSpecInput');
    return {
