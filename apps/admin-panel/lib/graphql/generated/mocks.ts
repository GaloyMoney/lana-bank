...
export const mockCollateralLiquidationRecordCollateralSentInput = (overrides?: Partial<CollateralLiquidationRecordCollateralSentInput>, _relationshipsToOmit: Set<string> = new Set()): CollateralLiquidationRecordCollateralSentInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CollateralLiquidationRecordCollateralSentInput');
    return {
...
export const mockCollateralLiquidationRecordCollateralSentPayload = (overrides?: Partial<CollateralLiquidationRecordCollateralSentPayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CollateralLiquidationRecordCollateralSentPayload' } & CollateralLiquidationRecordCollateralSentPayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CollateralLiquidationRecordCollateralSentPayload');
    return {
        __typename: 'CollateralLiquidationRecordCollateralSentPayload',
...
export const mockCollateralLiquidationRecordProceedsReceivedInput = (overrides?: Partial<CollateralLiquidationRecordProceedsReceivedInput>, _relationshipsToOmit: Set<string> = new Set()): CollateralLiquidationRecordProceedsReceivedInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CollateralLiquidationRecordProceedsReceivedInput');
    return {
...
export const mockCollateralLiquidationRecordProceedsReceivedPayload = (overrides?: Partial<CollateralLiquidationRecordProceedsReceivedPayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CollateralLiquidationRecordProceedsReceivedPayload' } & CollateralLiquidationRecordProceedsReceivedPayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CollateralLiquidationRecordProceedsReceivedPayload');
    return {
        __typename: 'CollateralLiquidationRecordProceedsReceivedPayload',
        collateral: overrides && overrides.hasOwnProperty('collateral') ? overrides.collateral! : relationshipsToOmit.has('Collateral') ? {} as Collateral : mockCollateral({}, relationshipsToOmit),
    };
};
...
export const mockMutation = (overrides?: Partial<Mutation>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Mutation' } & Mutation => {
    ...
    return {
        ...
        collateralLiquidationRecordCollateralSent: overrides && overrides.hasOwnProperty('collateralLiquidationRecordCollateralSent') ? overrides.collateralLiquidationRecordCollateralSent! : relationshipsToOmit.has('CollateralLiquidationRecordCollateralSentPayload') ? {} as CollateralLiquidationRecordCollateralSentPayload : mockCollateralLiquidationRecordCollateralSentPayload({}, relationshipsToOmit),
        collateralLiquidationRecordProceedsReceived: overrides && overrides.hasOwnProperty('collateralLiquidationRecordProceedsReceived') ? overrides.collateralLiquidationRecordProceedsReceived! : relationshipsToOmit.has('CollateralLiquidationRecordProceedsReceivedPayload') ? {} as CollateralLiquidationRecordProceedsReceivedPayload : mockCollateralLiquidationRecordProceedsReceivedPayload({}, relationshipsToOmit),
