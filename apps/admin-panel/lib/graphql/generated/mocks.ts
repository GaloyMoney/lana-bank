...
export const mockMutation = (overrides?: Partial<Mutation>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Mutation' } & Mutation => {
    ...
    return {
        ...
        withdrawalVoid: overrides && overrides.hasOwnProperty('withdrawalVoid') ? overrides.withdrawalVoid! : relationshipsToOmit.has('WithdrawalVoidPayload') ? {} as WithdrawalVoidPayload : mockWithdrawalVoidPayload({}, relationshipsToOmit),
    };
};
...
export const mockWithdrawalVoidInput = (overrides?: Partial<WithdrawalVoidInput>, _relationshipsToOmit: Set<string> = new Set()): WithdrawalVoidInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('WithdrawalVoidInput');
    return {
        withdrawalId: overrides && overrides.hasOwnProperty('withdrawalId') ? overrides.withdrawalId! : generateMockValue.uuid(),
    };
};

export const mockWithdrawalVoidPayload = (overrides?: Partial<WithdrawalVoidPayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'WithdrawalVoidPayload' } & WithdrawalVoidPayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('WithdrawalVoidPayload');
    return {
