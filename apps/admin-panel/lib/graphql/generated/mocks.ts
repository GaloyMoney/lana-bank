...
export const mockFiscalYearModuleConfig = (overrides?: Partial<FiscalYearModuleConfig>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'FiscalYearModuleConfig' } & FiscalYearModuleConfig => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('FiscalYearModuleConfig');
    return {
...
export const mockFiscalYearModuleConfigureInput = (overrides?: Partial<FiscalYearModuleConfigureInput>, _relationshipsToOmit: Set<string> = new Set()): FiscalYearModuleConfigureInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
...
export const mockFiscalYearModuleConfigurePayload = (overrides?: Partial<FiscalYearModuleConfigurePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'FiscalYearModuleConfigurePayload' } & FiscalYearModuleConfigurePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('FiscalYearModuleConfigurePayload');
    return {
        __typename: 'FiscalYearModuleConfigurePayload',
        fiscalYearConfig: overrides && overrides.hasOwnProperty('fiscalYearConfig') ? overrides.fiscalYearConfig! : relationshipsToOmit.has('FiscalYearModuleConfig') ? {} as FiscalYearModuleConfig : mockFiscalYearModuleConfig({}, relationshipsToOmit),
    };
};
...
export const mockMutation = (overrides?: Partial<Mutation>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Mutation' } & Mutation => {
    ...
    return {
        ...
        fiscalYearConfigure: overrides && overrides.hasOwnProperty('fiscalYearConfigure') ? overrides.fiscalYearConfigure! : relationshipsToOmit.has('FiscalYearModuleConfigurePayload') ? {} as FiscalYearModuleConfigurePayload : mockFiscalYearModuleConfigurePayload({}, relationshipsToOmit),
