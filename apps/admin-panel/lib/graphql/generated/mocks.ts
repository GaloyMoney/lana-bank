...
export const mockQuery = (overrides?: Partial<Query>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Query' } & Query => {
    ...
    return {
        ...
        offBalanceSheetAccountSets: overrides && overrides.hasOwnProperty('offBalanceSheetAccountSets') ? overrides.offBalanceSheetAccountSets! : [relationshipsToOmit.has('AccountInfo') ? {} as AccountInfo : mockAccountInfo({}, relationshipsToOmit)],
