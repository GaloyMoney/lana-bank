...
export const mockCreditFacilityExport = (overrides?: Partial<CreditFacilityExport>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CreditFacilityExport' } & CreditFacilityExport => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CreditFacilityExport');
    return {
        __typename: 'CreditFacilityExport',
        createdAt: overrides && overrides.hasOwnProperty('createdAt') ? overrides.createdAt! : generateMockValue.timestamp(),
        id: overrides && overrides.hasOwnProperty('id') ? overrides.id! : faker.string.uuid(),
        status: overrides && overrides.hasOwnProperty('status') ? overrides.status! : CreditFacilityExportStatus.Completed,
    };
};

export const mockCreditFacilityExportInput = (overrides?: Partial<CreditFacilityExportInput>, _relationshipsToOmit: Set<string> = new Set()): CreditFacilityExportInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CreditFacilityExportInput');
    return {
        generate: overrides && overrides.hasOwnProperty('generate') ? overrides.generate! : faker.datatype.boolean(),
    };
};
...
export const mockLoanAgreementInput = (overrides?: Partial<LoanAgreementInput>, _relationshipsToOmit: Set<string> = new Set()): LoanAgreementInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('LoanAgreementInput');
    return {
        customerId: overrides && overrides.hasOwnProperty('customerId') ? overrides.customerId! : generateMockValue.uuid(),
    };
};
...
export const mockMutation = (overrides?: Partial<Mutation>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Mutation' } & Mutation => {
    ...
    return {
        ...
        pdfDownloadLinkGenerate: overrides && overrides.hasOwnProperty('pdfDownloadLinkGenerate') ? overrides.pdfDownloadLinkGenerate! : relationshipsToOmit.has('PdfDownloadLinkGeneratePayload') ? {} as PdfDownloadLinkGeneratePayload : mockPdfDownloadLinkGeneratePayload({}, relationshipsToOmit),
        pdfGenerate: overrides && overrides.hasOwnProperty('pdfGenerate') ? overrides.pdfGenerate! : relationshipsToOmit.has('PdfGeneratePayload') ? {} as PdfGeneratePayload : mockPdfGeneratePayload({}, relationshipsToOmit),
...
export const mockPdfDownloadLinkGenerateInput = (overrides?: Partial<PdfDownloadLinkGenerateInput>, _relationshipsToOmit: Set<string> = new Set()): PdfDownloadLinkGenerateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PdfDownloadLinkGenerateInput');
    return {
        pdfId: overrides && overrides.hasOwnProperty('pdfId') ? overrides.pdfId! : generateMockValue.uuid(),
    };
};

export const mockPdfDownloadLinkGeneratePayload = (overrides?: Partial<PdfDownloadLinkGeneratePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'PdfDownloadLinkGeneratePayload' } & PdfDownloadLinkGeneratePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PdfDownloadLinkGeneratePayload');
    return {
...
export const mockPdfGenerateInput = (override?: PdfGenerateInput, _relationshipsToOmit: Set<string> = new Set()): PdfGenerateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PdfGenerateInput');
    return {
        ...(override ? override : {creditFacilityExport : relationshipsToOmit.has('CreditFacilityExportInput') ? {} as CreditFacilityExportInput : mockCreditFacilityExportInput({}, relationshipsToOmit)}),
    };
};

export const mockPdfGeneratePayload = (overrides?: Partial<PdfGeneratePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'PdfGeneratePayload' } & PdfGeneratePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PdfGeneratePayload');
    return {
        __typename: 'PdfGeneratePayload',
        document: overrides && overrides.hasOwnProperty('document') ? overrides.document! : relationshipsToOmit.has('CreditFacilityExport') ? {} as CreditFacilityExport : mockCreditFacilityExport({}, relationshipsToOmit),
    };
};
...
export const mockQuery = (overrides?: Partial<Query>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Query' } & Query => {
    ...
    return {
        ...
        creditFacilityExport: overrides && overrides.hasOwnProperty('creditFacilityExport') ? overrides.creditFacilityExport! : relationshipsToOmit.has('CreditFacilityExport') ? {} as CreditFacilityExport : mockCreditFacilityExport({}, relationshipsToOmit),
        creditFacilityProposal: overrides && overrides.hasOwnProperty('creditFacilityProposal') ? overrides.creditFacilityProposal! : relationshipsToOmit.has('CreditFacilityProposal') ? {} as CreditFacilityProposal : mockCreditFacilityProposal({}, relationshipsToOmit),
