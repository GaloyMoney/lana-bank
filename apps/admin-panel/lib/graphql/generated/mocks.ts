...
export const mockTestPingEvent = (overrides?: Partial<TestPingEvent>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'TestPingEvent' } & TestPingEvent => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('TestPingEvent');
    return {
        __typename: 'TestPingEvent',
        message: overrides && overrides.hasOwnProperty('message') ? overrides.message! : faker.lorem.word(),
        timestamp: overrides && overrides.hasOwnProperty('timestamp') ? overrides.timestamp! : faker.lorem.word(),
    };
};
