...
export const mockApprovalProcessConcludedPayload = (overrides?: Partial<ApprovalProcessConcludedPayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'ApprovalProcessConcludedPayload' } & ApprovalProcessConcludedPayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ApprovalProcessConcludedPayload');
    return {
        ...
        deniedReason: overrides && overrides.hasOwnProperty('deniedReason') ? overrides.deniedReason! : generateMockValue.deniedReason(),
        processType: overrides && overrides.hasOwnProperty('processType') ? overrides.processType! : ApprovalProcessType.CreditFacilityProposalApproval,
...
export const mockSubscription = (overrides?: Partial<Subscription>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Subscription' } & Subscription => {
    ...
    return {
        ...
        approvalProcessConcluded: overrides && overrides.hasOwnProperty('approvalProcessConcluded') ? overrides.approvalProcessConcluded! : relationshipsToOmit.has('ApprovalProcessConcludedPayload') ? {} as ApprovalProcessConcludedPayload : mockApprovalProcessConcludedPayload({}, relationshipsToOmit),
