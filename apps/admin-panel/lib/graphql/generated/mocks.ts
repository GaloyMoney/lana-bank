...
export const mockAccountingClosing = (overrides?: Partial<AccountingClosing>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'AccountingClosing' } & AccountingClosing => {
    ...
    return {
        ...
        monthly: overrides && overrides.hasOwnProperty('monthly') ? overrides.monthly! : relationshipsToOmit.has('PeriodClosing') ? {} as PeriodClosing : mockPeriodClosing({}, relationshipsToOmit),
    };
};
...
export const mockPeriodClosing = (overrides?: Partial<PeriodClosing>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'PeriodClosing' } & PeriodClosing => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PeriodClosing');
    return {
