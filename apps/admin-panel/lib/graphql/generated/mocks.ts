...
export const mockMutation = (overrides?: Partial<Mutation>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Mutation' } & Mutation => {
    ...
    return {
        ...
        sumsubTestApplicantCreate: overrides && overrides.hasOwnProperty('sumsubTestApplicantCreate') ? overrides.sumsubTestApplicantCreate! : relationshipsToOmit.has('SumsubTestApplicantCreatePayload') ? {} as SumsubTestApplicantCreatePayload : mockSumsubTestApplicantCreatePayload({}, relationshipsToOmit),
...
export const mockSumsubTestApplicantCreateInput = (overrides?: Partial<SumsubTestApplicantCreateInput>, _relationshipsToOmit: Set<string> = new Set()): SumsubTestApplicantCreateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('SumsubTestApplicantCreateInput');
    return {
        customerId: overrides && overrides.hasOwnProperty('customerId') ? overrides.customerId! : generateMockValue.uuid(),
    };
};

export const mockSumsubTestApplicantCreatePayload = (overrides?: Partial<SumsubTestApplicantCreatePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'SumsubTestApplicantCreatePayload' } & SumsubTestApplicantCreatePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('SumsubTestApplicantCreatePayload');
    return {
