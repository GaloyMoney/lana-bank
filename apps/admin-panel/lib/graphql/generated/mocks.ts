...
export const mockCreditModuleConfigUpdateInput = (overrides?: Partial<CreditModuleConfigUpdateInput>, _relationshipsToOmit: Set<string> = new Set()): CreditModuleConfigUpdateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CreditModuleConfigUpdateInput');
    return {
        chartOfAccountCollateralOmnibusParentCode: overrides && overrides.hasOwnProperty('chartOfAccountCollateralOmnibusParentCode') ? overrides.chartOfAccountCollateralOmnibusParentCode! : faker.lorem.word(),
        chartOfAccountCollateralParentCode: overrides && overrides.hasOwnProperty('chartOfAccountCollateralParentCode') ? overrides.chartOfAccountCollateralParentCode! : faker.lorem.word(),
        chartOfAccountDisbursedReceivableParentCode: overrides && overrides.hasOwnProperty('chartOfAccountDisbursedReceivableParentCode') ? overrides.chartOfAccountDisbursedReceivableParentCode! : faker.lorem.word(),
...
export const mockCreditModuleConfigUpdatePayload = (overrides?: Partial<CreditModuleConfigUpdatePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CreditModuleConfigUpdatePayload' } & CreditModuleConfigUpdatePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CreditModuleConfigUpdatePayload');
    return {
...
export const mockDepositModuleConfigUpdateInput = (overrides?: Partial<DepositModuleConfigUpdateInput>, _relationshipsToOmit: Set<string> = new Set()): DepositModuleConfigUpdateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
...
export const mockDepositModuleConfigUpdatePayload = (overrides?: Partial<DepositModuleConfigUpdatePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'DepositModuleConfigUpdatePayload' } & DepositModuleConfigUpdatePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('DepositModuleConfigUpdatePayload');
    return {
...
export const mockMutation = (overrides?: Partial<Mutation>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Mutation' } & Mutation => {
    ...
    return {
        ...
        creditConfigUpdate: overrides && overrides.hasOwnProperty('creditConfigUpdate') ? overrides.creditConfigUpdate! : relationshipsToOmit.has('CreditModuleConfigUpdatePayload') ? {} as CreditModuleConfigUpdatePayload : mockCreditModuleConfigUpdatePayload({}, relationshipsToOmit),
        ...
        depositConfigUpdate: overrides && overrides.hasOwnProperty('depositConfigUpdate') ? overrides.depositConfigUpdate! : relationshipsToOmit.has('DepositModuleConfigUpdatePayload') ? {} as DepositModuleConfigUpdatePayload : mockDepositModuleConfigUpdatePayload({}, relationshipsToOmit),
