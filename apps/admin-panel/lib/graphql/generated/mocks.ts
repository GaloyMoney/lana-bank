...
export const mockChartAddControlAccountInput = (overrides?: Partial<ChartAddControlAccountInput>, _relationshipsToOmit: Set<string> = new Set()): ChartAddControlAccountInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ChartAddControlAccountInput');
    return {
        categoryType: overrides && overrides.hasOwnProperty('categoryType') ? overrides.categoryType! : ChartCategoryType.Assets,
        chartId: overrides && overrides.hasOwnProperty('chartId') ? overrides.chartId! : generateMockValue.uuid(),
        controlAccountId: overrides && overrides.hasOwnProperty('controlAccountId') ? overrides.controlAccountId! : generateMockValue.uuid(),
        name: overrides && overrides.hasOwnProperty('name') ? overrides.name! : generateMockValue.name(),
        reference: overrides && overrides.hasOwnProperty('reference') ? overrides.reference! : generateMockValue.reference(),
    };
};

export const mockChartAddControlAccountPayload = (overrides?: Partial<ChartAddControlAccountPayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'ChartAddControlAccountPayload' } & ChartAddControlAccountPayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ChartAddControlAccountPayload');
    return {
        __typename: 'ChartAddControlAccountPayload',
        chart: overrides && overrides.hasOwnProperty('chart') ? overrides.chart! : relationshipsToOmit.has('ChartOfAccounts') ? {} as ChartOfAccounts : mockChartOfAccounts({}, relationshipsToOmit),
    };
};
...
export const mockMutation = (overrides?: Partial<Mutation>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Mutation' } & Mutation => {
    ...
    return {
        ...
        chartAddControlAccount: overrides && overrides.hasOwnProperty('chartAddControlAccount') ? overrides.chartAddControlAccount! : relationshipsToOmit.has('ChartAddControlAccountPayload') ? {} as ChartAddControlAccountPayload : mockChartAddControlAccountPayload({}, relationshipsToOmit),
