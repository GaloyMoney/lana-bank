...
export const mockTermValues = (overrides?: Partial<TermValues>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'TermValues' } & TermValues => {
    ...
    return {
        ...
        facilityDisbursalRule: overrides && overrides.hasOwnProperty('facilityDisbursalRule') ? overrides.facilityDisbursalRule! : FacilityDisbursalRule.OnCreditFacilityActivation,
