...
export const mockFiscalYearModuleConfig = (overrides?: Partial<FiscalYearModuleConfig>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'FiscalYearModuleConfig' } & FiscalYearModuleConfig => {
    ...
    return {
        ...
        yearEndMonth: overrides && overrides.hasOwnProperty('yearEndMonth') ? overrides.yearEndMonth! : faker.number.int({ min: 0, max: 9999 }),
    };
};
...
export const mockMutation = (overrides?: Partial<Mutation>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Mutation' } & Mutation => {
    ...
    return {
        ...
        fiscalYearModuleConfigure: overrides && overrides.hasOwnProperty('fiscalYearModuleConfigure') ? overrides.fiscalYearModuleConfigure! : relationshipsToOmit.has('FiscalYearModuleConfigurePayload') ? {} as FiscalYearModuleConfigurePayload : mockFiscalYearModuleConfigurePayload({}, relationshipsToOmit),
...
export const mockQuery = (overrides?: Partial<Query>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Query' } & Query => {
    ...
    return {
        ...
        fiscalYear: overrides && overrides.hasOwnProperty('fiscalYear') ? overrides.fiscalYear! : relationshipsToOmit.has('FiscalYear') ? {} as FiscalYear : mockFiscalYear({}, relationshipsToOmit),
        fiscalYearModuleConfig: overrides && overrides.hasOwnProperty('fiscalYearModuleConfig') ? overrides.fiscalYearModuleConfig! : relationshipsToOmit.has('FiscalYearModuleConfig') ? {} as FiscalYearModuleConfig : mockFiscalYearModuleConfig({}, relationshipsToOmit),
