...
export const mockCustomer = (overrides?: Partial<Customer>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Customer' } & Customer => {
    ...
    return {
        ...
        conversion: overrides && overrides.hasOwnProperty('conversion') ? overrides.conversion! : relationshipsToOmit.has('ManuallyConverted') ? {} as ManuallyConverted : mockManuallyConverted({}, relationshipsToOmit),
        createdAt: overrides && overrides.hasOwnProperty('createdAt') ? overrides.createdAt! : generateMockValue.timestamp(),
...
export const mockManuallyConverted = (overrides?: Partial<ManuallyConverted>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'ManuallyConverted' } & ManuallyConverted => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ManuallyConverted');
    return {
        __typename: 'ManuallyConverted',
        convertedBy: overrides && overrides.hasOwnProperty('convertedBy') ? overrides.convertedBy! : faker.lorem.word(),
    };
};
...
export const mockSumsubApproved = (overrides?: Partial<SumsubApproved>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'SumsubApproved' } & SumsubApproved => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('SumsubApproved');
    return {
