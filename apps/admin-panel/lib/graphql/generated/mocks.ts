...
import { AccountInfo, AccountingBaseConfigInput, AccountingBaseConfigOutput, ApprovalProcess, ApprovalProcessApproveInput, ApprovalProcessApprovePayload, ApprovalProcessConnection, ApprovalProcessDenyInput, ApprovalProcessDenyPayload, ApprovalProcessEdge, ApprovalProcessVoter, AuditEntry, AuditEntryConnection, AuditEntryEdge, AutoApproval, BalanceSheet, BalanceSheetAccount, BitfinexCreateInput, BitgoConfigInput, BtcAmount, BtcBalanceDetails, BtcLedgerAccountBalance, BtcLedgerAccountBalanceRange, BuildInfo, CancelledWithdrawalEntry, ChartNode, ChartOfAccounts, ChartOfAccountsAddChildNodeInput, ChartOfAccountsAddChildNodePayload, ChartOfAccountsCsvImportInput, ChartOfAccountsCsvImportPayload, ChartOfAccountsCsvImportWithBaseConfigInput, ChartOfAccountsCsvImportWithBaseConfigPayload, Collateral, CollateralRecordProceedsFromLiquidationInput, CollateralRecordProceedsFromLiquidationPayload, CollateralRecordSentToLiquidationInput, CollateralRecordSentToLiquidationPayload, CollateralUpdateInput, CollateralUpdatePayload, Committee, CommitteeApproval, CommitteeConnection, CommitteeCreateInput, CommitteeCreatePayload, CommitteeEdge, CommitteeUserAddInput, CommitteeUserAddPayload, CommitteeUserRemoveInput, CommitteeUserRemovePayload, CommitteesSort, CreditFacilitiesFilter, CreditFacilitiesSort, CreditFacility, CreditFacilityAgreement, CreditFacilityAgreementDownloadLinksGenerateInput, CreditFacilityAgreementDownloadLinksGeneratePayload, CreditFacilityAgreementGenerateInput, CreditFacilityAgreementGeneratePayload, CreditFacilityApproved, CreditFacilityBalance, CreditFacilityCollateralSentOut, CreditFacilityCollateralUpdated, CreditFacilityCollateralizationUpdated, CreditFacilityCompleteInput, CreditFacilityCompletePayload, CreditFacilityConnection, CreditFacilityDisbursal, CreditFacilityDisbursalConnection, CreditFacilityDisbursalEdge, CreditFacilityDisbursalExecuted, CreditFacilityDisbursalInitiateInput, CreditFacilityDisbursalInitiatePayload, CreditFacilityEdge, CreditFacilityIncrementalPayment, CreditFacilityInterestAccrued, CreditFacilityLedgerAccounts, CreditFacilityModuleConfig, CreditFacilityModuleConfigureInput, CreditFacilityModuleConfigurePayload, CreditFacilityPartialPaymentRecordInput, CreditFacilityPartialPaymentRecordPayload, CreditFacilityPartialPaymentWithDateRecordInput, CreditFacilityPaymentAllocation, CreditFacilityProposal, CreditFacilityProposalConnection, CreditFacilityProposalCreateInput, CreditFacilityProposalCreatePayload, CreditFacilityProposalCustomerApprovalConcludeInput, CreditFacilityProposalCustomerApprovalConcludePayload, CreditFacilityProposalEdge, CreditFacilityProposalsFilter, CreditFacilityProposalsSort, CreditFacilityRepaymentAmountReceived, CreditFacilityRepaymentPlanEntry, Custodian, CustodianConfigInput, CustodianConfigUpdateInput, CustodianConfigUpdatePayload, CustodianConnection, CustodianCreateInput, CustodianCreatePayload, CustodianEdge, CustodiansSort, Customer, CustomerCloseInput, CustomerClosePayload, CustomerConnection, CustomerDocument, CustomerDocumentArchiveInput, CustomerDocumentArchivePayload, CustomerDocumentCreateInput, CustomerDocumentCreatePayload, CustomerDocumentDeleteInput, CustomerDocumentDeletePayload, CustomerDocumentDownloadLinksGenerateInput, CustomerDocumentDownloadLinksGeneratePayload, CustomerEdge, CustomerEmailUpdateInput, CustomerEmailUpdatePayload, CustomerFreezeInput, CustomerFreezePayload, CustomerTelegramHandleUpdateInput, CustomerTelegramHandleUpdatePayload, CustomerUnfreezeInput, CustomerUnfreezePayload, CustomersFilter, CustomersSort, Dashboard, Deposit, DepositAccount, DepositAccountBalance, DepositAccountCloseInput, DepositAccountClosePayload, DepositAccountConnection, DepositAccountCreateInput, DepositAccountCreatePayload, DepositAccountEdge, DepositAccountFreezeInput, DepositAccountFreezePayload, DepositAccountHistoryEntryConnection, DepositAccountHistoryEntryEdge, DepositAccountLedgerAccounts, DepositAccountModuleConfig, DepositAccountModuleConfigureInput, DepositAccountModuleConfigurePayload, DepositAccountUnfreezeInput, DepositAccountUnfreezePayload, DepositAccountsFilter, DepositAccountsSort, DepositConnection, DepositEdge, DepositEntry, DepositRecordInput, DepositRecordPayload, DepositRevertInput, DepositRevertPayload, DepositsFilter, DepositsSort, DisbursalEntry, DisbursalsFilter, DisbursalsSort, Disbursed, DomainConfig, DomainConfigConnection, DomainConfigEdge, DomainConfigUpdateInput, DomainConfigUpdatePayload, Duration, DurationInput, EventTimelineEntry, EventTimelineEntryConnection, EventTimelineEntryEdge, FiniteCvlPct, FiscalMonthClosure, FiscalYear, FiscalYearCloseInput, FiscalYearCloseMonthInput, FiscalYearCloseMonthPayload, FiscalYearClosePayload, FiscalYearConnection, FiscalYearEdge, FiscalYearInitInput, FiscalYearInitPayload, FiscalYearOpenNextInput, FiscalYearOpenNextPayload, FiscalYearsSort, FreezeEntry, GovernanceNavigationItems, InfiniteCvlPct, Interest, KomainuConfigInput, LedgerAccount, LedgerAccountBalanceByCurrency, LedgerAccountBalanceRangeByCurrency, LedgerAccountCsvCreateInput, LedgerAccountCsvCreatePayload, LedgerAccountCsvDocument, LedgerAccountCsvDownloadLink, LedgerAccountCsvDownloadLinkGenerateInput, LedgerAccountCsvDownloadLinkGeneratePayload, LedgerAccountCsvExportUploadedPayload, LedgerEntry, LedgerEntryConnection, LedgerEntryEdge, LedgerManualTransactionExecuteInput, LedgerManualTransactionExecutePayload, LedgerTransaction, LedgerTransactionConnection, LedgerTransactionEdge, Liquidation, LiquidationCollateralSent, LiquidationConnection, LiquidationEdge, LiquidationPayment, LiquidationPaymentCalculateInput, LiquidationProceedsReceived, LiquidationsSort, Loan, ManualConfigInput, ManualPriceConfigInput, ManualTransactionEntryInput, Me, Mutation, PageInfo, PaymentEntry, PendingCreditFacilitiesFilter, PendingCreditFacilitiesSort, PendingCreditFacility, PendingCreditFacilityCollateralizationUpdated, PendingCreditFacilityConnection, PendingCreditFacilityEdge, PermissionSet, PermissionSetConnection, PermissionSetEdge, PersonalInfo, Policy, PolicyCommitteeAssignInput, PolicyCommitteeAssignPayload, PolicyConnection, PolicyEdge, PriceProvider, PriceProviderActivateInput, PriceProviderActivatePayload, PriceProviderConfigInput, PriceProviderConfigUpdateInput, PriceProviderConfigUpdatePayload, PriceProviderConnection, PriceProviderDeactivateInput, PriceProviderDeactivatePayload, PriceProviderEdge, PriceProvidersSort, ProfitAndLossAccount, ProfitAndLossStatement, Prospect, ProspectCloseInput, ProspectClosePayload, ProspectConnection, ProspectConvertInput, ProspectConvertPayload, ProspectCreateInput, ProspectCreatePayload, ProspectEdge, ProspectKycLinkCreateInput, ProspectKycLinkCreatePayload, ProspectsFilter, ProspectsSort, Query, RealtimePrice, Report, ReportDefinition, ReportDefinitionOutput, ReportFile, ReportFileDownloadLinkGenerateInput, ReportFileDownloadLinkGeneratePayload, ReportRun, ReportRunConnection, ReportRunEdge, ReportRunTriggerInput, ReportRunTriggerPayload, ReportRunUpdatedPayload, ReportRunsSort, RequestedReport, Role, RoleConnection, RoleCreateInput, RoleCreatePayload, RoleEdge, RolePermissionSetsAddInput, RolePermissionSetsAddPayload, RolePermissionSetsRemoveInput, RolePermissionSetsRemovePayload, RolesSort, SelfCustodyConfigInput, Subscription, System, TermValues, TermsInput, TermsTemplate, TermsTemplateCreateInput, TermsTemplateCreatePayload, TermsTemplateUpdateInput, TermsTemplateUpdatePayload, Time, TimeAdvanceToNextEndOfDayPayload, TransactionTemplate, TransactionTemplateConnection, TransactionTemplateEdge, TrialBalance, UnfreezeEntry, UnknownEntry, UsdAmount, UsdBalanceDetails, UsdLedgerAccountBalance, UsdLedgerAccountBalanceRange, User, UserConnection, UserCreateInput, UserCreatePayload, UserEdge, UserRoleUpdateInput, UserRoleUpdatePayload, UsersSort, VisibleNavigationItems, Wallet, Withdrawal, WithdrawalCancelInput, WithdrawalCancelPayload, WithdrawalConfirmInput, WithdrawalConfirmPayload, WithdrawalConnection, WithdrawalEdge, WithdrawalEntry, WithdrawalInitiateInput, WithdrawalInitiatePayload, WithdrawalRevertInput, WithdrawalRevertPayload, WithdrawalsFilter, WithdrawalsSort, AccountCategory, Activity, ApprovalProcessStatus, ApprovalProcessType, CollateralDirection, CollateralizationState, CommitteesSortBy, ConfigType, ConversionReason, CreditFacilitiesSortBy, CreditFacilityAgreementStatus, CreditFacilityProposalStatus, CreditFacilityProposalsSortBy, CreditFacilityRepaymentStatus, CreditFacilityRepaymentType, CreditFacilityStatus, CustodiansSortBy, CustomerStatus, CustomerType, CustomersSortBy, DebitOrCredit, DepositAccountStatus, DepositAccountsSortBy, DepositStatus, DepositsSortBy, DisbursalPolicy, DisbursalStatus, DisbursalsSortBy, DocumentStatus, FiscalYearsSortBy, InterestInterval, KycLevel, KycStatus, Layer, LiquidationsSortBy, PendingCreditFacilitiesSortBy, PendingCreditFacilityCollateralizationState, PendingCreditFacilityStatus, Period, PriceProvidersSortBy, ProspectStage, ProspectsSortBy, ReportOutputFormat, ReportRunState, ReportRunType, ReportRunsSortBy, RolesSortBy, SelfCustodyNetwork, SortDirection, UsersSortBy, WalletNetwork, WithdrawalStatus, WithdrawalsSortBy } from './index';
...
export const mockApprovalProcess = (overrides?: Partial<ApprovalProcess>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'ApprovalProcess' } & ApprovalProcess => {
    ...
    return {
        ...
        rules: overrides && overrides.hasOwnProperty('rules') ? overrides.rules! : relationshipsToOmit.has('AutoApproval') ? {} as AutoApproval : mockAutoApproval({}, relationshipsToOmit),
...
export const mockAutoApproval = (overrides?: Partial<AutoApproval>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'AutoApproval' } & AutoApproval => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('AutoApproval');
    return {
...
export const mockBalanceSheet = (overrides?: Partial<BalanceSheet>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'BalanceSheet' } & BalanceSheet => {
    ...
    return {
        ...
        assetsBalance: overrides && overrides.hasOwnProperty('assetsBalance') ? overrides.assetsBalance! : relationshipsToOmit.has('LedgerAccountBalanceByCurrency') ? {} as LedgerAccountBalanceByCurrency : mockLedgerAccountBalanceByCurrency({}, relationshipsToOmit),
        categories: overrides && overrides.hasOwnProperty('categories') ? overrides.categories! : [relationshipsToOmit.has('BalanceSheetAccount') ? {} as BalanceSheetAccount : mockBalanceSheetAccount({}, relationshipsToOmit)],
...
export const mockBalanceSheetAccount = (overrides?: Partial<BalanceSheetAccount>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'BalanceSheetAccount' } & BalanceSheetAccount => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('BalanceSheetAccount');
    return {
...
export const mockBitfinexCreateInput = (overrides?: Partial<BitfinexCreateInput>, _relationshipsToOmit: Set<string> = new Set()): BitfinexCreateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('BitfinexCreateInput');
    return {
        name: overrides && overrides.hasOwnProperty('name') ? overrides.name! : generateMockValue.name(),
    };
};

export const mockBitgoConfigInput = (overrides?: Partial<BitgoConfigInput>, _relationshipsToOmit: Set<string> = new Set()): BitgoConfigInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('BitgoConfigInput');
    return {
...
export const mockBuildInfo = (overrides?: Partial<BuildInfo>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'BuildInfo' } & BuildInfo => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('BuildInfo');
    return {
        __typename: 'BuildInfo',
        buildProfile: overrides && overrides.hasOwnProperty('buildProfile') ? overrides.buildProfile! : faker.lorem.word(),
        buildTarget: overrides && overrides.hasOwnProperty('buildTarget') ? overrides.buildTarget! : faker.lorem.word(),
        enabledFeatures: overrides && overrides.hasOwnProperty('enabledFeatures') ? overrides.enabledFeatures! : [faker.lorem.word()],
...
export const mockCommitteeApproval = (overrides?: Partial<CommitteeApproval>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CommitteeApproval' } & CommitteeApproval => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CommitteeApproval');
    return {
...
export const mockCommitteeUserAddInput = (overrides?: Partial<CommitteeUserAddInput>, _relationshipsToOmit: Set<string> = new Set()): CommitteeUserAddInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CommitteeUserAddInput');
    return {
        committeeId: overrides && overrides.hasOwnProperty('committeeId') ? overrides.committeeId! : generateMockValue.uuid(),
...
export const mockCommitteeUserAddPayload = (overrides?: Partial<CommitteeUserAddPayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CommitteeUserAddPayload' } & CommitteeUserAddPayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CommitteeUserAddPayload');
    return {
...
export const mockCommitteeUserRemoveInput = (overrides?: Partial<CommitteeUserRemoveInput>, _relationshipsToOmit: Set<string> = new Set()): CommitteeUserRemoveInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CommitteeUserRemoveInput');
    return {
        committeeId: overrides && overrides.hasOwnProperty('committeeId') ? overrides.committeeId! : generateMockValue.uuid(),
        userId: overrides && overrides.hasOwnProperty('userId') ? overrides.userId! : generateMockValue.uuid(),
    };
...
export const mockCommitteeUserRemovePayload = (overrides?: Partial<CommitteeUserRemovePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CommitteeUserRemovePayload' } & CommitteeUserRemovePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CommitteeUserRemovePayload');
    return {
...
export const mockCreditFacilityAgreement = (overrides?: Partial<CreditFacilityAgreement>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CreditFacilityAgreement' } & CreditFacilityAgreement => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CreditFacilityAgreement');
    return {
        __typename: 'CreditFacilityAgreement',
        createdAt: overrides && overrides.hasOwnProperty('createdAt') ? overrides.createdAt! : generateMockValue.timestamp(),
        creditFacilityAgreementId: overrides && overrides.hasOwnProperty('creditFacilityAgreementId') ? overrides.creditFacilityAgreementId! : generateMockValue.uuid(),
        status: overrides && overrides.hasOwnProperty('status') ? overrides.status! : CreditFacilityAgreementStatus.Completed,
    };
};

export const mockCreditFacilityAgreementDownloadLinksGenerateInput = (overrides?: Partial<CreditFacilityAgreementDownloadLinksGenerateInput>, _relationshipsToOmit: Set<string> = new Set()): CreditFacilityAgreementDownloadLinksGenerateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CreditFacilityAgreementDownloadLinksGenerateInput');
    return {
        creditFacilityAgreementId: overrides && overrides.hasOwnProperty('creditFacilityAgreementId') ? overrides.creditFacilityAgreementId! : generateMockValue.uuid(),
    };
};

export const mockCreditFacilityAgreementDownloadLinksGeneratePayload = (overrides?: Partial<CreditFacilityAgreementDownloadLinksGeneratePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CreditFacilityAgreementDownloadLinksGeneratePayload' } & CreditFacilityAgreementDownloadLinksGeneratePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CreditFacilityAgreementDownloadLinksGeneratePayload');
    return {
...
export const mockCreditFacilityAgreementGenerateInput = (overrides?: Partial<CreditFacilityAgreementGenerateInput>, _relationshipsToOmit: Set<string> = new Set()): CreditFacilityAgreementGenerateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
...
export const mockCreditFacilityAgreementGeneratePayload = (overrides?: Partial<CreditFacilityAgreementGeneratePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CreditFacilityAgreementGeneratePayload' } & CreditFacilityAgreementGeneratePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CreditFacilityAgreementGeneratePayload');
    return {
...
export const mockCreditFacilityBalance = (overrides?: Partial<CreditFacilityBalance>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CreditFacilityBalance' } & CreditFacilityBalance => {
    ...
    return {
        ...
        dueOutstanding: overrides && overrides.hasOwnProperty('dueOutstanding') ? overrides.dueOutstanding! : generateMockValue.usdCents(),
        facilityRemaining: overrides && overrides.hasOwnProperty('facilityRemaining') ? overrides.facilityRemaining! : generateMockValue.usdCents(),
        ...
        outstandingPayable: overrides && overrides.hasOwnProperty('outstandingPayable') ? overrides.outstandingPayable! : generateMockValue.usdCents(),
        paymentsUnapplied: overrides && overrides.hasOwnProperty('paymentsUnapplied') ? overrides.paymentsUnapplied! : generateMockValue.usdCents(),
    };
};
...
export const mockCreditFacilityDisbursalInitiatePayload = (overrides?: Partial<CreditFacilityDisbursalInitiatePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CreditFacilityDisbursalInitiatePayload' } & CreditFacilityDisbursalInitiatePayload => {
    ...
    return {
        ...
        creditFacilityDisbursal: overrides && overrides.hasOwnProperty('creditFacilityDisbursal') ? overrides.creditFacilityDisbursal! : relationshipsToOmit.has('CreditFacilityDisbursal') ? {} as CreditFacilityDisbursal : mockCreditFacilityDisbursal({}, relationshipsToOmit),
    };
};
...
export const mockCreditFacilityModuleConfig = (overrides?: Partial<CreditFacilityModuleConfig>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CreditFacilityModuleConfig' } & CreditFacilityModuleConfig => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CreditFacilityModuleConfig');
    return {
        __typename: 'CreditFacilityModuleConfig',
...
export const mockCreditFacilityModuleConfigureInput = (overrides?: Partial<CreditFacilityModuleConfigureInput>, _relationshipsToOmit: Set<string> = new Set()): CreditFacilityModuleConfigureInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CreditFacilityModuleConfigureInput');
    return {
        chartOfAccountCollateralInLiquidationParentCode: overrides && overrides.hasOwnProperty('chartOfAccountCollateralInLiquidationParentCode') ? overrides.chartOfAccountCollateralInLiquidationParentCode! : faker.lorem.word(),
        chartOfAccountCollateralOmnibusParentCode: overrides && overrides.hasOwnProperty('chartOfAccountCollateralOmnibusParentCode') ? overrides.chartOfAccountCollateralOmnibusParentCode! : faker.lorem.word(),
        chartOfAccountCollateralParentCode: overrides && overrides.hasOwnProperty('chartOfAccountCollateralParentCode') ? overrides.chartOfAccountCollateralParentCode! : faker.lorem.word(),
...
export const mockCreditFacilityModuleConfigurePayload = (overrides?: Partial<CreditFacilityModuleConfigurePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CreditFacilityModuleConfigurePayload' } & CreditFacilityModuleConfigurePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CreditFacilityModuleConfigurePayload');
    return {
        __typename: 'CreditFacilityModuleConfigurePayload',
        creditFacilityConfig: overrides && overrides.hasOwnProperty('creditFacilityConfig') ? overrides.creditFacilityConfig! : relationshipsToOmit.has('CreditFacilityModuleConfig') ? {} as CreditFacilityModuleConfig : mockCreditFacilityModuleConfig({}, relationshipsToOmit),
    };
};
...
export const mockCreditFacilityProposalsFilter = (overrides?: Partial<CreditFacilityProposalsFilter>, _relationshipsToOmit: Set<string> = new Set()): CreditFacilityProposalsFilter => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CreditFacilityProposalsFilter');
    return {
        status: overrides && overrides.hasOwnProperty('status') ? overrides.status! : CreditFacilityProposalStatus.Approved,
    };
};

export const mockCreditFacilityProposalsSort = (overrides?: Partial<CreditFacilityProposalsSort>, _relationshipsToOmit: Set<string> = new Set()): CreditFacilityProposalsSort => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CreditFacilityProposalsSort');
    return {
        by: overrides && overrides.hasOwnProperty('by') ? overrides.by! : CreditFacilityProposalsSortBy.CreatedAt,
        direction: overrides && overrides.hasOwnProperty('direction') ? overrides.direction! : SortDirection.Asc,
    };
};
...
export const mockCustodianConfigInput = (override?: CustodianConfigInput, _relationshipsToOmit: Set<string> = new Set()): CustodianConfigInput => {
    ...
    return {
        ...(override ? override : {bitgo : relationshipsToOmit.has('BitgoConfigInput') ? {} as BitgoConfigInput : mockBitgoConfigInput({}, relationshipsToOmit)}),
    };
};
...
export const mockCustomer = (overrides?: Partial<Customer>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Customer' } & Customer => {
    ...
    return {
        ...
        conversionReason: overrides && overrides.hasOwnProperty('conversionReason') ? overrides.conversionReason! : ConversionReason.ManuallyConverted,
        createdAt: overrides && overrides.hasOwnProperty('createdAt') ? overrides.createdAt! : generateMockValue.timestamp(),
...
export const mockCustomerCloseInput = (overrides?: Partial<CustomerCloseInput>, _relationshipsToOmit: Set<string> = new Set()): CustomerCloseInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CustomerCloseInput');
    return {
        customerId: overrides && overrides.hasOwnProperty('customerId') ? overrides.customerId! : generateMockValue.uuid(),
    };
};

export const mockCustomerClosePayload = (overrides?: Partial<CustomerClosePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CustomerClosePayload' } & CustomerClosePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CustomerClosePayload');
    return {
...
export const mockCustomerFreezeInput = (overrides?: Partial<CustomerFreezeInput>, _relationshipsToOmit: Set<string> = new Set()): CustomerFreezeInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CustomerFreezeInput');
    return {
        customerId: overrides && overrides.hasOwnProperty('customerId') ? overrides.customerId! : generateMockValue.uuid(),
    };
};

export const mockCustomerFreezePayload = (overrides?: Partial<CustomerFreezePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CustomerFreezePayload' } & CustomerFreezePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CustomerFreezePayload');
    return {
...
export const mockCustomerUnfreezeInput = (overrides?: Partial<CustomerUnfreezeInput>, _relationshipsToOmit: Set<string> = new Set()): CustomerUnfreezeInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CustomerUnfreezeInput');
    return {
        customerId: overrides && overrides.hasOwnProperty('customerId') ? overrides.customerId! : generateMockValue.uuid(),
    };
};

export const mockCustomerUnfreezePayload = (overrides?: Partial<CustomerUnfreezePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CustomerUnfreezePayload' } & CustomerUnfreezePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CustomerUnfreezePayload');
    return {
...
export const mockDepositAccountModuleConfig = (overrides?: Partial<DepositAccountModuleConfig>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'DepositAccountModuleConfig' } & DepositAccountModuleConfig => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('DepositAccountModuleConfig');
    return {
        __typename: 'DepositAccountModuleConfig',
        chartOfAccountsBankDepositAccountsParentCode: overrides && overrides.hasOwnProperty('chartOfAccountsBankDepositAccountsParentCode') ? overrides.chartOfAccountsBankDepositAccountsParentCode! : faker.lorem.word(),
        chartOfAccountsFinancialInstitutionDepositAccountsParentCode: overrides && overrides.hasOwnProperty('chartOfAccountsFinancialInstitutionDepositAccountsParentCode') ? overrides.chartOfAccountsFinancialInstitutionDepositAccountsParentCode! : faker.lorem.word(),
        chartOfAccountsFrozenBankDepositAccountsParentCode: overrides && overrides.hasOwnProperty('chartOfAccountsFrozenBankDepositAccountsParentCode') ? overrides.chartOfAccountsFrozenBankDepositAccountsParentCode! : faker.lorem.word(),
        chartOfAccountsFrozenFinancialInstitutionDepositAccountsParentCode: overrides && overrides.hasOwnProperty('chartOfAccountsFrozenFinancialInstitutionDepositAccountsParentCode') ? overrides.chartOfAccountsFrozenFinancialInstitutionDepositAccountsParentCode! : faker.lorem.word(),
        ...
        chartOfAccountsFrozenNonDomiciledCompanyDepositAccountsParentCode: overrides && overrides.hasOwnProperty('chartOfAccountsFrozenNonDomiciledCompanyDepositAccountsParentCode') ? overrides.chartOfAccountsFrozenNonDomiciledCompanyDepositAccountsParentCode! : faker.lorem.word(),
        chartOfAccountsFrozenPrivateCompanyDepositAccountsParentCode: overrides && overrides.hasOwnProperty('chartOfAccountsFrozenPrivateCompanyDepositAccountsParentCode') ? overrides.chartOfAccountsFrozenPrivateCompanyDepositAccountsParentCode! : faker.lorem.word(),
        ...
        chartOfAccountsNonDomiciledCompanyDepositAccountsParentCode: overrides && overrides.hasOwnProperty('chartOfAccountsNonDomiciledCompanyDepositAccountsParentCode') ? overrides.chartOfAccountsNonDomiciledCompanyDepositAccountsParentCode! : faker.lorem.word(),
        ...
        chartOfAccountsPrivateCompanyDepositAccountsParentCode: overrides && overrides.hasOwnProperty('chartOfAccountsPrivateCompanyDepositAccountsParentCode') ? overrides.chartOfAccountsPrivateCompanyDepositAccountsParentCode! : faker.lorem.word(),
    };
};

export const mockDepositAccountModuleConfigureInput = (overrides?: Partial<DepositAccountModuleConfigureInput>, _relationshipsToOmit: Set<string> = new Set()): DepositAccountModuleConfigureInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('DepositAccountModuleConfigureInput');
    return {
        chartOfAccountsBankDepositAccountsParentCode: overrides && overrides.hasOwnProperty('chartOfAccountsBankDepositAccountsParentCode') ? overrides.chartOfAccountsBankDepositAccountsParentCode! : faker.lorem.word(),
        chartOfAccountsFinancialInstitutionDepositAccountsParentCode: overrides && overrides.hasOwnProperty('chartOfAccountsFinancialInstitutionDepositAccountsParentCode') ? overrides.chartOfAccountsFinancialInstitutionDepositAccountsParentCode! : faker.lorem.word(),
        chartOfAccountsFrozenBankDepositAccountsParentCode: overrides && overrides.hasOwnProperty('chartOfAccountsFrozenBankDepositAccountsParentCode') ? overrides.chartOfAccountsFrozenBankDepositAccountsParentCode! : faker.lorem.word(),
...
export const mockDepositAccountModuleConfigurePayload = (overrides?: Partial<DepositAccountModuleConfigurePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'DepositAccountModuleConfigurePayload' } & DepositAccountModuleConfigurePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('DepositAccountModuleConfigurePayload');
    return {
        __typename: 'DepositAccountModuleConfigurePayload',
        depositAccountConfig: overrides && overrides.hasOwnProperty('depositAccountConfig') ? overrides.depositAccountConfig! : relationshipsToOmit.has('DepositAccountModuleConfig') ? {} as DepositAccountModuleConfig : mockDepositAccountModuleConfig({}, relationshipsToOmit),
    };
};
...
export const mockDepositAccountsFilter = (overrides?: Partial<DepositAccountsFilter>, _relationshipsToOmit: Set<string> = new Set()): DepositAccountsFilter => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
...
export const mockDepositsFilter = (overrides?: Partial<DepositsFilter>, _relationshipsToOmit: Set<string> = new Set()): DepositsFilter => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('DepositsFilter');
    return {
        status: overrides && overrides.hasOwnProperty('status') ? overrides.status! : DepositStatus.Confirmed,
    };
};
...
export const mockDisbursalsFilter = (overrides?: Partial<DisbursalsFilter>, _relationshipsToOmit: Set<string> = new Set()): DisbursalsFilter => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
...
export const mockDisbursed = (overrides?: Partial<Disbursed>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Disbursed' } & Disbursed => {
    ...
    return {
        ...
        outstanding: overrides && overrides.hasOwnProperty('outstanding') ? overrides.outstanding! : generateMockValue.usdCents(),
        outstandingPayable: overrides && overrides.hasOwnProperty('outstandingPayable') ? overrides.outstandingPayable! : generateMockValue.usdCents(),
        total: overrides && overrides.hasOwnProperty('total') ? overrides.total! : generateMockValue.usdCents(),
    };
};
...
export const mockEventTimelineEntry = (overrides?: Partial<EventTimelineEntry>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'EventTimelineEntry' } & EventTimelineEntry => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('EventTimelineEntry');
    return {
        __typename: 'EventTimelineEntry',
        auditEntryId: overrides && overrides.hasOwnProperty('auditEntryId') ? overrides.auditEntryId! : faker.lorem.word(),
        eventType: overrides && overrides.hasOwnProperty('eventType') ? overrides.eventType! : faker.lorem.word(),
...
export const mockEventTimelineEntryConnection = (overrides?: Partial<EventTimelineEntryConnection>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'EventTimelineEntryConnection' } & EventTimelineEntryConnection => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('EventTimelineEntryConnection');
    return {
        __typename: 'EventTimelineEntryConnection',
        edges: overrides && overrides.hasOwnProperty('edges') ? overrides.edges! : [relationshipsToOmit.has('EventTimelineEntryEdge') ? {} as EventTimelineEntryEdge : mockEventTimelineEntryEdge({}, relationshipsToOmit)],
        nodes: overrides && overrides.hasOwnProperty('nodes') ? overrides.nodes! : [relationshipsToOmit.has('EventTimelineEntry') ? {} as EventTimelineEntry : mockEventTimelineEntry({}, relationshipsToOmit)],
        pageInfo: overrides && overrides.hasOwnProperty('pageInfo') ? overrides.pageInfo! : relationshipsToOmit.has('PageInfo') ? {} as PageInfo : mockPageInfo({}, relationshipsToOmit),
    };
};

export const mockEventTimelineEntryEdge = (overrides?: Partial<EventTimelineEntryEdge>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'EventTimelineEntryEdge' } & EventTimelineEntryEdge => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('EventTimelineEntryEdge');
    return {
        __typename: 'EventTimelineEntryEdge',
        cursor: overrides && overrides.hasOwnProperty('cursor') ? overrides.cursor! : generateMockValue.cursor(),
        node: overrides && overrides.hasOwnProperty('node') ? overrides.node! : relationshipsToOmit.has('EventTimelineEntry') ? {} as EventTimelineEntry : mockEventTimelineEntry({}, relationshipsToOmit),
    };
};
...
export const mockKomainuConfigInput = (overrides?: Partial<KomainuConfigInput>, _relationshipsToOmit: Set<string> = new Set()): KomainuConfigInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('KomainuConfigInput');
    return {
...
export const mockLedgerAccount = (overrides?: Partial<LedgerAccount>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'LedgerAccount' } & LedgerAccount => {
    ...
    return {
        ...
        history: overrides && overrides.hasOwnProperty('history') ? overrides.history! : relationshipsToOmit.has('LedgerEntryConnection') ? {} as LedgerEntryConnection : mockLedgerEntryConnection({}, relationshipsToOmit),
...
export const mockLedgerAccountCsvCreatePayload = (overrides?: Partial<LedgerAccountCsvCreatePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'LedgerAccountCsvCreatePayload' } & LedgerAccountCsvCreatePayload => {
    ...
    return {
        ...
        ledgerAccountCsvDocument: overrides && overrides.hasOwnProperty('ledgerAccountCsvDocument') ? overrides.ledgerAccountCsvDocument! : relationshipsToOmit.has('LedgerAccountCsvDocument') ? {} as LedgerAccountCsvDocument : mockLedgerAccountCsvDocument({}, relationshipsToOmit),
    };
};

export const mockLedgerAccountCsvDocument = (overrides?: Partial<LedgerAccountCsvDocument>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'LedgerAccountCsvDocument' } & LedgerAccountCsvDocument => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('LedgerAccountCsvDocument');
    return {
...
export const mockLedgerAccountCsvDownloadLink = (overrides?: Partial<LedgerAccountCsvDownloadLink>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'LedgerAccountCsvDownloadLink' } & LedgerAccountCsvDownloadLink => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('LedgerAccountCsvDownloadLink');
    return {
...
export const mockLedgerAccountCsvDownloadLinkGenerateInput = (overrides?: Partial<LedgerAccountCsvDownloadLinkGenerateInput>, _relationshipsToOmit: Set<string> = new Set()): LedgerAccountCsvDownloadLinkGenerateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
...
export const mockLedgerAccountCsvDownloadLinkGeneratePayload = (overrides?: Partial<LedgerAccountCsvDownloadLinkGeneratePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'LedgerAccountCsvDownloadLinkGeneratePayload' } & LedgerAccountCsvDownloadLinkGeneratePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('LedgerAccountCsvDownloadLinkGeneratePayload');
    return {
        __typename: 'LedgerAccountCsvDownloadLinkGeneratePayload',
        link: overrides && overrides.hasOwnProperty('link') ? overrides.link! : relationshipsToOmit.has('LedgerAccountCsvDownloadLink') ? {} as LedgerAccountCsvDownloadLink : mockLedgerAccountCsvDownloadLink({}, relationshipsToOmit),
    };
};
...
export const mockLedgerEntry = (overrides?: Partial<LedgerEntry>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'LedgerEntry' } & LedgerEntry => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('LedgerEntry');
    return {
        ...
        ledgerEntryId: overrides && overrides.hasOwnProperty('ledgerEntryId') ? overrides.ledgerEntryId! : generateMockValue.uuid(),
...
export const mockLedgerEntryConnection = (overrides?: Partial<LedgerEntryConnection>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'LedgerEntryConnection' } & LedgerEntryConnection => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('LedgerEntryConnection');
    return {
        __typename: 'LedgerEntryConnection',
        edges: overrides && overrides.hasOwnProperty('edges') ? overrides.edges! : [relationshipsToOmit.has('LedgerEntryEdge') ? {} as LedgerEntryEdge : mockLedgerEntryEdge({}, relationshipsToOmit)],
        nodes: overrides && overrides.hasOwnProperty('nodes') ? overrides.nodes! : [relationshipsToOmit.has('LedgerEntry') ? {} as LedgerEntry : mockLedgerEntry({}, relationshipsToOmit)],
        pageInfo: overrides && overrides.hasOwnProperty('pageInfo') ? overrides.pageInfo! : relationshipsToOmit.has('PageInfo') ? {} as PageInfo : mockPageInfo({}, relationshipsToOmit),
    };
};

export const mockLedgerEntryEdge = (overrides?: Partial<LedgerEntryEdge>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'LedgerEntryEdge' } & LedgerEntryEdge => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('LedgerEntryEdge');
    return {
        __typename: 'LedgerEntryEdge',
        cursor: overrides && overrides.hasOwnProperty('cursor') ? overrides.cursor! : generateMockValue.cursor(),
        node: overrides && overrides.hasOwnProperty('node') ? overrides.node! : relationshipsToOmit.has('LedgerEntry') ? {} as LedgerEntry : mockLedgerEntry({}, relationshipsToOmit),
    };
};

export const mockLedgerManualTransactionExecuteInput = (overrides?: Partial<LedgerManualTransactionExecuteInput>, _relationshipsToOmit: Set<string> = new Set()): LedgerManualTransactionExecuteInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('LedgerManualTransactionExecuteInput');
    return {
        description: overrides && overrides.hasOwnProperty('description') ? overrides.description! : generateMockValue.description(),
        effective: overrides && overrides.hasOwnProperty('effective') ? overrides.effective! : faker.date.past({ years: 1, refDate: new Date(2022, 0) }).toISOString(),
...
export const mockLedgerManualTransactionExecutePayload = (overrides?: Partial<LedgerManualTransactionExecutePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'LedgerManualTransactionExecutePayload' } & LedgerManualTransactionExecutePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('LedgerManualTransactionExecutePayload');
    return {
...
export const mockLiquidationPayment = (overrides?: Partial<LiquidationPayment>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'LiquidationPayment' } & LiquidationPayment => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
...
export const mockLiquidationPaymentCalculateInput = (overrides?: Partial<LiquidationPaymentCalculateInput>, _relationshipsToOmit: Set<string> = new Set()): LiquidationPaymentCalculateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('LiquidationPaymentCalculateInput');
    return {
        liquidationId: overrides && overrides.hasOwnProperty('liquidationId') ? overrides.liquidationId! : generateMockValue.uuid(),
        outstanding: overrides && overrides.hasOwnProperty('outstanding') ? overrides.outstanding! : generateMockValue.usdCents(),
        targetCvl: overrides && overrides.hasOwnProperty('targetCvl') ? overrides.targetCvl! : faker.lorem.word(),
        toLiquidate: overrides && overrides.hasOwnProperty('toLiquidate') ? overrides.toLiquidate! : generateMockValue.satoshis(),
        toReceive: overrides && overrides.hasOwnProperty('toReceive') ? overrides.toReceive! : generateMockValue.usdCents(),
    };
};
...
export const mockManualConfigInput = (overrides?: Partial<ManualConfigInput>, _relationshipsToOmit: Set<string> = new Set()): ManualConfigInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ManualConfigInput');
    return {
        name: overrides && overrides.hasOwnProperty('name') ? overrides.name! : generateMockValue.name(),
    };
};

export const mockManualPriceConfigInput = (overrides?: Partial<ManualPriceConfigInput>, _relationshipsToOmit: Set<string> = new Set()): ManualPriceConfigInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ManualPriceConfigInput');
    return {
        usdCentsPerBtc: overrides && overrides.hasOwnProperty('usdCentsPerBtc') ? overrides.usdCentsPerBtc! : faker.number.int({ min: 0, max: 9999 }),
    };
};
...
export const mockMutation = (overrides?: Partial<Mutation>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Mutation' } & Mutation => {
    ...
    return {
        ...
        committeeUserAdd: overrides && overrides.hasOwnProperty('committeeUserAdd') ? overrides.committeeUserAdd! : relationshipsToOmit.has('CommitteeUserAddPayload') ? {} as CommitteeUserAddPayload : mockCommitteeUserAddPayload({}, relationshipsToOmit),
        committeeUserRemove: overrides && overrides.hasOwnProperty('committeeUserRemove') ? overrides.committeeUserRemove! : relationshipsToOmit.has('CommitteeUserRemovePayload') ? {} as CommitteeUserRemovePayload : mockCommitteeUserRemovePayload({}, relationshipsToOmit),
        creditFacilityAgreementDownloadLinkGenerate: overrides && overrides.hasOwnProperty('creditFacilityAgreementDownloadLinkGenerate') ? overrides.creditFacilityAgreementDownloadLinkGenerate! : relationshipsToOmit.has('CreditFacilityAgreementDownloadLinksGeneratePayload') ? {} as CreditFacilityAgreementDownloadLinksGeneratePayload : mockCreditFacilityAgreementDownloadLinksGeneratePayload({}, relationshipsToOmit),
        creditFacilityAgreementGenerate: overrides && overrides.hasOwnProperty('creditFacilityAgreementGenerate') ? overrides.creditFacilityAgreementGenerate! : relationshipsToOmit.has('CreditFacilityAgreementGeneratePayload') ? {} as CreditFacilityAgreementGeneratePayload : mockCreditFacilityAgreementGeneratePayload({}, relationshipsToOmit),
        ...
        creditFacilityModuleConfigure: overrides && overrides.hasOwnProperty('creditFacilityModuleConfigure') ? overrides.creditFacilityModuleConfigure! : relationshipsToOmit.has('CreditFacilityModuleConfigurePayload') ? {} as CreditFacilityModuleConfigurePayload : mockCreditFacilityModuleConfigurePayload({}, relationshipsToOmit),
        ...
        customerClose: overrides && overrides.hasOwnProperty('customerClose') ? overrides.customerClose! : relationshipsToOmit.has('CustomerClosePayload') ? {} as CustomerClosePayload : mockCustomerClosePayload({}, relationshipsToOmit),
        ...
        customerDocumentCreate: overrides && overrides.hasOwnProperty('customerDocumentCreate') ? overrides.customerDocumentCreate! : relationshipsToOmit.has('CustomerDocumentCreatePayload') ? {} as CustomerDocumentCreatePayload : mockCustomerDocumentCreatePayload({}, relationshipsToOmit),
        ...
        customerFreeze: overrides && overrides.hasOwnProperty('customerFreeze') ? overrides.customerFreeze! : relationshipsToOmit.has('CustomerFreezePayload') ? {} as CustomerFreezePayload : mockCustomerFreezePayload({}, relationshipsToOmit),
        ...
        customerUnfreeze: overrides && overrides.hasOwnProperty('customerUnfreeze') ? overrides.customerUnfreeze! : relationshipsToOmit.has('CustomerUnfreezePayload') ? {} as CustomerUnfreezePayload : mockCustomerUnfreezePayload({}, relationshipsToOmit),
        ...
        depositAccountModuleConfigure: overrides && overrides.hasOwnProperty('depositAccountModuleConfigure') ? overrides.depositAccountModuleConfigure! : relationshipsToOmit.has('DepositAccountModuleConfigurePayload') ? {} as DepositAccountModuleConfigurePayload : mockDepositAccountModuleConfigurePayload({}, relationshipsToOmit),
        ...
        ledgerAccountCsvDownloadLinkGenerate: overrides && overrides.hasOwnProperty('ledgerAccountCsvDownloadLinkGenerate') ? overrides.ledgerAccountCsvDownloadLinkGenerate! : relationshipsToOmit.has('LedgerAccountCsvDownloadLinkGeneratePayload') ? {} as LedgerAccountCsvDownloadLinkGeneratePayload : mockLedgerAccountCsvDownloadLinkGeneratePayload({}, relationshipsToOmit),
        ledgerManualTransactionExecute: overrides && overrides.hasOwnProperty('ledgerManualTransactionExecute') ? overrides.ledgerManualTransactionExecute! : relationshipsToOmit.has('LedgerManualTransactionExecutePayload') ? {} as LedgerManualTransactionExecutePayload : mockLedgerManualTransactionExecutePayload({}, relationshipsToOmit),
        policyCommitteeAssign: overrides && overrides.hasOwnProperty('policyCommitteeAssign') ? overrides.policyCommitteeAssign! : relationshipsToOmit.has('PolicyCommitteeAssignPayload') ? {} as PolicyCommitteeAssignPayload : mockPolicyCommitteeAssignPayload({}, relationshipsToOmit),
        priceProviderActivate: overrides && overrides.hasOwnProperty('priceProviderActivate') ? overrides.priceProviderActivate! : relationshipsToOmit.has('PriceProviderActivatePayload') ? {} as PriceProviderActivatePayload : mockPriceProviderActivatePayload({}, relationshipsToOmit),
        priceProviderConfigUpdate: overrides && overrides.hasOwnProperty('priceProviderConfigUpdate') ? overrides.priceProviderConfigUpdate! : relationshipsToOmit.has('PriceProviderConfigUpdatePayload') ? {} as PriceProviderConfigUpdatePayload : mockPriceProviderConfigUpdatePayload({}, relationshipsToOmit),
        priceProviderDeactivate: overrides && overrides.hasOwnProperty('priceProviderDeactivate') ? overrides.priceProviderDeactivate! : relationshipsToOmit.has('PriceProviderDeactivatePayload') ? {} as PriceProviderDeactivatePayload : mockPriceProviderDeactivatePayload({}, relationshipsToOmit),
        ...
        prospectKycLinkCreate: overrides && overrides.hasOwnProperty('prospectKycLinkCreate') ? overrides.prospectKycLinkCreate! : relationshipsToOmit.has('ProspectKycLinkCreatePayload') ? {} as ProspectKycLinkCreatePayload : mockProspectKycLinkCreatePayload({}, relationshipsToOmit),
        reportFileDownloadLinkGenerate: overrides && overrides.hasOwnProperty('reportFileDownloadLinkGenerate') ? overrides.reportFileDownloadLinkGenerate! : relationshipsToOmit.has('ReportFileDownloadLinkGeneratePayload') ? {} as ReportFileDownloadLinkGeneratePayload : mockReportFileDownloadLinkGeneratePayload({}, relationshipsToOmit),
        reportRunTrigger: overrides && overrides.hasOwnProperty('reportRunTrigger') ? overrides.reportRunTrigger! : relationshipsToOmit.has('ReportRunTriggerPayload') ? {} as ReportRunTriggerPayload : mockReportRunTriggerPayload({}, relationshipsToOmit),
        ...
        rolePermissionSetsAdd: overrides && overrides.hasOwnProperty('rolePermissionSetsAdd') ? overrides.rolePermissionSetsAdd! : relationshipsToOmit.has('RolePermissionSetsAddPayload') ? {} as RolePermissionSetsAddPayload : mockRolePermissionSetsAddPayload({}, relationshipsToOmit),
        rolePermissionSetsRemove: overrides && overrides.hasOwnProperty('rolePermissionSetsRemove') ? overrides.rolePermissionSetsRemove! : relationshipsToOmit.has('RolePermissionSetsRemovePayload') ? {} as RolePermissionSetsRemovePayload : mockRolePermissionSetsRemovePayload({}, relationshipsToOmit),
        ...
        timeAdvanceToNextEndOfDay: overrides && overrides.hasOwnProperty('timeAdvanceToNextEndOfDay') ? overrides.timeAdvanceToNextEndOfDay! : relationshipsToOmit.has('TimeAdvanceToNextEndOfDayPayload') ? {} as TimeAdvanceToNextEndOfDayPayload : mockTimeAdvanceToNextEndOfDayPayload({}, relationshipsToOmit),
        ...
        userRoleUpdate: overrides && overrides.hasOwnProperty('userRoleUpdate') ? overrides.userRoleUpdate! : relationshipsToOmit.has('UserRoleUpdatePayload') ? {} as UserRoleUpdatePayload : mockUserRoleUpdatePayload({}, relationshipsToOmit),
...
export const mockPendingCreditFacilitiesFilter = (overrides?: Partial<PendingCreditFacilitiesFilter>, _relationshipsToOmit: Set<string> = new Set()): PendingCreditFacilitiesFilter => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
...
export const mockPendingCreditFacilitiesSort = (overrides?: Partial<PendingCreditFacilitiesSort>, _relationshipsToOmit: Set<string> = new Set()): PendingCreditFacilitiesSort => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PendingCreditFacilitiesSort');
    return {
        by: overrides && overrides.hasOwnProperty('by') ? overrides.by! : PendingCreditFacilitiesSortBy.CreatedAt,
        direction: overrides && overrides.hasOwnProperty('direction') ? overrides.direction! : SortDirection.Asc,
    };
};
...
export const mockPolicyCommitteeAssignInput = (overrides?: Partial<PolicyCommitteeAssignInput>, _relationshipsToOmit: Set<string> = new Set()): PolicyCommitteeAssignInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PolicyCommitteeAssignInput');
    return {
        committeeId: overrides && overrides.hasOwnProperty('committeeId') ? overrides.committeeId! : generateMockValue.uuid(),
        policyId: overrides && overrides.hasOwnProperty('policyId') ? overrides.policyId! : generateMockValue.uuid(),
    };
...
export const mockPolicyCommitteeAssignPayload = (overrides?: Partial<PolicyCommitteeAssignPayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'PolicyCommitteeAssignPayload' } & PolicyCommitteeAssignPayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PolicyCommitteeAssignPayload');
    return {
...
export const mockPriceProvider = (overrides?: Partial<PriceProvider>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'PriceProvider' } & PriceProvider => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PriceProvider');
    return {
...
export const mockPriceProviderActivateInput = (overrides?: Partial<PriceProviderActivateInput>, _relationshipsToOmit: Set<string> = new Set()): PriceProviderActivateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PriceProviderActivateInput');
    return {
        priceProviderId: overrides && overrides.hasOwnProperty('priceProviderId') ? overrides.priceProviderId! : generateMockValue.uuid(),
    };
};

export const mockPriceProviderActivatePayload = (overrides?: Partial<PriceProviderActivatePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'PriceProviderActivatePayload' } & PriceProviderActivatePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PriceProviderActivatePayload');
    return {
        __typename: 'PriceProviderActivatePayload',
        priceProvider: overrides && overrides.hasOwnProperty('priceProvider') ? overrides.priceProvider! : relationshipsToOmit.has('PriceProvider') ? {} as PriceProvider : mockPriceProvider({}, relationshipsToOmit),
    };
};

export const mockPriceProviderConfigInput = (override?: PriceProviderConfigInput, _relationshipsToOmit: Set<string> = new Set()): PriceProviderConfigInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PriceProviderConfigInput');
    return {
        ...(override ? override : {bitfinex : relationshipsToOmit.has('BitfinexCreateInput') ? {} as BitfinexCreateInput : mockBitfinexCreateInput({}, relationshipsToOmit)}),
    };
};

export const mockPriceProviderConfigUpdateInput = (overrides?: Partial<PriceProviderConfigUpdateInput>, _relationshipsToOmit: Set<string> = new Set()): PriceProviderConfigUpdateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PriceProviderConfigUpdateInput');
    return {
        config: overrides && overrides.hasOwnProperty('config') ? overrides.config! : mockPriceProviderConfigInput(),
        priceProviderId: overrides && overrides.hasOwnProperty('priceProviderId') ? overrides.priceProviderId! : generateMockValue.uuid(),
    };
};

export const mockPriceProviderConfigUpdatePayload = (overrides?: Partial<PriceProviderConfigUpdatePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'PriceProviderConfigUpdatePayload' } & PriceProviderConfigUpdatePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PriceProviderConfigUpdatePayload');
    return {
...
export const mockPriceProviderConnection = (overrides?: Partial<PriceProviderConnection>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'PriceProviderConnection' } & PriceProviderConnection => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PriceProviderConnection');
    return {
        __typename: 'PriceProviderConnection',
        edges: overrides && overrides.hasOwnProperty('edges') ? overrides.edges! : [relationshipsToOmit.has('PriceProviderEdge') ? {} as PriceProviderEdge : mockPriceProviderEdge({}, relationshipsToOmit)],
        nodes: overrides && overrides.hasOwnProperty('nodes') ? overrides.nodes! : [relationshipsToOmit.has('PriceProvider') ? {} as PriceProvider : mockPriceProvider({}, relationshipsToOmit)],
        pageInfo: overrides && overrides.hasOwnProperty('pageInfo') ? overrides.pageInfo! : relationshipsToOmit.has('PageInfo') ? {} as PageInfo : mockPageInfo({}, relationshipsToOmit),
    };
};

export const mockPriceProviderDeactivateInput = (overrides?: Partial<PriceProviderDeactivateInput>, _relationshipsToOmit: Set<string> = new Set()): PriceProviderDeactivateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PriceProviderDeactivateInput');
    return {
        priceProviderId: overrides && overrides.hasOwnProperty('priceProviderId') ? overrides.priceProviderId! : generateMockValue.uuid(),
    };
};

export const mockPriceProviderDeactivatePayload = (overrides?: Partial<PriceProviderDeactivatePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'PriceProviderDeactivatePayload' } & PriceProviderDeactivatePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PriceProviderDeactivatePayload');
    return {
...
export const mockPriceProviderEdge = (overrides?: Partial<PriceProviderEdge>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'PriceProviderEdge' } & PriceProviderEdge => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PriceProviderEdge');
    return {
        __typename: 'PriceProviderEdge',
        cursor: overrides && overrides.hasOwnProperty('cursor') ? overrides.cursor! : generateMockValue.cursor(),
        node: overrides && overrides.hasOwnProperty('node') ? overrides.node! : relationshipsToOmit.has('PriceProvider') ? {} as PriceProvider : mockPriceProvider({}, relationshipsToOmit),
    };
};

export const mockPriceProvidersSort = (overrides?: Partial<PriceProvidersSort>, _relationshipsToOmit: Set<string> = new Set()): PriceProvidersSort => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PriceProvidersSort');
    return {
        by: overrides && overrides.hasOwnProperty('by') ? overrides.by! : PriceProvidersSortBy.CreatedAt,
        direction: overrides && overrides.hasOwnProperty('direction') ? overrides.direction! : SortDirection.Asc,
    };
};
...
export const mockProfitAndLossAccount = (overrides?: Partial<ProfitAndLossAccount>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'ProfitAndLossAccount' } & ProfitAndLossAccount => {
    ...
    return {
        ...
        balanceRange: overrides && overrides.hasOwnProperty('balanceRange') ? overrides.balanceRange! : relationshipsToOmit.has('LedgerAccountBalanceRangeByCurrency') ? {} as LedgerAccountBalanceRangeByCurrency : mockLedgerAccountBalanceRangeByCurrency({}, relationshipsToOmit),
...
export const mockProspectKycLinkCreateInput = (overrides?: Partial<ProspectKycLinkCreateInput>, _relationshipsToOmit: Set<string> = new Set()): ProspectKycLinkCreateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ProspectKycLinkCreateInput');
    return {
        prospectId: overrides && overrides.hasOwnProperty('prospectId') ? overrides.prospectId! : generateMockValue.uuid(),
    };
};

export const mockProspectKycLinkCreatePayload = (overrides?: Partial<ProspectKycLinkCreatePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'ProspectKycLinkCreatePayload' } & ProspectKycLinkCreatePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ProspectKycLinkCreatePayload');
    return {
...
export const mockProspectsFilter = (overrides?: Partial<ProspectsFilter>, _relationshipsToOmit: Set<string> = new Set()): ProspectsFilter => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
...
export const mockProspectsSort = (overrides?: Partial<ProspectsSort>, _relationshipsToOmit: Set<string> = new Set()): ProspectsSort => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ProspectsSort');
    return {
        by: overrides && overrides.hasOwnProperty('by') ? overrides.by! : ProspectsSortBy.CreatedAt,
        direction: overrides && overrides.hasOwnProperty('direction') ? overrides.direction! : SortDirection.Asc,
    };
};
...
export const mockQuery = (overrides?: Partial<Query>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Query' } & Query => {
    ...
    return {
        ...
        availableReportDefinitions: overrides && overrides.hasOwnProperty('availableReportDefinitions') ? overrides.availableReportDefinitions! : [relationshipsToOmit.has('ReportDefinition') ? {} as ReportDefinition : mockReportDefinition({}, relationshipsToOmit)],
        ...
        buildInfo: overrides && overrides.hasOwnProperty('buildInfo') ? overrides.buildInfo! : relationshipsToOmit.has('BuildInfo') ? {} as BuildInfo : mockBuildInfo({}, relationshipsToOmit),
        chartOfAccounts: overrides && overrides.hasOwnProperty('chartOfAccounts') ? overrides.chartOfAccounts! : relationshipsToOmit.has('ChartOfAccounts') ? {} as ChartOfAccounts : mockChartOfAccounts({}, relationshipsToOmit),
        committee: overrides && overrides.hasOwnProperty('committee') ? overrides.committee! : relationshipsToOmit.has('Committee') ? {} as Committee : mockCommittee({}, relationshipsToOmit),
        ...
        ledgerAccountCsv: overrides && overrides.hasOwnProperty('ledgerAccountCsv') ? overrides.ledgerAccountCsv! : relationshipsToOmit.has('LedgerAccountCsvDocument') ? {} as LedgerAccountCsvDocument : mockLedgerAccountCsvDocument({}, relationshipsToOmit),
        ledgerEntries: overrides && overrides.hasOwnProperty('ledgerEntries') ? overrides.ledgerEntries! : relationshipsToOmit.has('LedgerEntryConnection') ? {} as LedgerEntryConnection : mockLedgerEntryConnection({}, relationshipsToOmit),
        ledgerTransaction: overrides && overrides.hasOwnProperty('ledgerTransaction') ? overrides.ledgerTransaction! : relationshipsToOmit.has('LedgerTransaction') ? {} as LedgerTransaction : mockLedgerTransaction({}, relationshipsToOmit),
        ...
        liquidationPaymentCalculate: overrides && overrides.hasOwnProperty('liquidationPaymentCalculate') ? overrides.liquidationPaymentCalculate! : relationshipsToOmit.has('LiquidationPayment') ? {} as LiquidationPayment : mockLiquidationPayment({}, relationshipsToOmit),
        ...
        policy: overrides && overrides.hasOwnProperty('policy') ? overrides.policy! : relationshipsToOmit.has('Policy') ? {} as Policy : mockPolicy({}, relationshipsToOmit),
        priceProviders: overrides && overrides.hasOwnProperty('priceProviders') ? overrides.priceProviders! : relationshipsToOmit.has('PriceProviderConnection') ? {} as PriceProviderConnection : mockPriceProviderConnection({}, relationshipsToOmit),
        ...
        time: overrides && overrides.hasOwnProperty('time') ? overrides.time! : relationshipsToOmit.has('Time') ? {} as Time : mockTime({}, relationshipsToOmit),
...
export const mockReportDefinition = (overrides?: Partial<ReportDefinition>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'ReportDefinition' } & ReportDefinition => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ReportDefinition');
    return {
...
export const mockReportDefinitionOutput = (overrides?: Partial<ReportDefinitionOutput>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'ReportDefinitionOutput' } & ReportDefinitionOutput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ReportDefinitionOutput');
    return {
        __typename: 'ReportDefinitionOutput',
        format: overrides && overrides.hasOwnProperty('format') ? overrides.format! : ReportOutputFormat.Csv,
    };
};
...
export const mockReportFileDownloadLinkGenerateInput = (overrides?: Partial<ReportFileDownloadLinkGenerateInput>, _relationshipsToOmit: Set<string> = new Set()): ReportFileDownloadLinkGenerateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ReportFileDownloadLinkGenerateInput');
    return {
        extension: overrides && overrides.hasOwnProperty('extension') ? overrides.extension! : faker.lorem.word(),
        reportId: overrides && overrides.hasOwnProperty('reportId') ? overrides.reportId! : generateMockValue.uuid(),
    };
...
export const mockReportFileDownloadLinkGeneratePayload = (overrides?: Partial<ReportFileDownloadLinkGeneratePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'ReportFileDownloadLinkGeneratePayload' } & ReportFileDownloadLinkGeneratePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ReportFileDownloadLinkGeneratePayload');
    return {
...
export const mockReportRun = (overrides?: Partial<ReportRun>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'ReportRun' } & ReportRun => {
    ...
    return {
        ...
        requestedAsOfDate: overrides && overrides.hasOwnProperty('requestedAsOfDate') ? overrides.requestedAsOfDate! : faker.date.past({ years: 1, refDate: new Date(2022, 0) }).toISOString(),
        requestedReport: overrides && overrides.hasOwnProperty('requestedReport') ? overrides.requestedReport! : relationshipsToOmit.has('RequestedReport') ? {} as RequestedReport : mockRequestedReport({}, relationshipsToOmit),
...
export const mockReportRunTriggerInput = (overrides?: Partial<ReportRunTriggerInput>, _relationshipsToOmit: Set<string> = new Set()): ReportRunTriggerInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
...
export const mockReportRunTriggerPayload = (overrides?: Partial<ReportRunTriggerPayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'ReportRunTriggerPayload' } & ReportRunTriggerPayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ReportRunTriggerPayload');
    return {
...
export const mockReportRunsSort = (overrides?: Partial<ReportRunsSort>, _relationshipsToOmit: Set<string> = new Set()): ReportRunsSort => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ReportRunsSort');
    return {
        by: overrides && overrides.hasOwnProperty('by') ? overrides.by! : ReportRunsSortBy.StartTime,
        direction: overrides && overrides.hasOwnProperty('direction') ? overrides.direction! : SortDirection.Asc,
    };
};

export const mockRequestedReport = (overrides?: Partial<RequestedReport>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'RequestedReport' } & RequestedReport => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('RequestedReport');
    return {
...
export const mockRolePermissionSetsAddInput = (overrides?: Partial<RolePermissionSetsAddInput>, _relationshipsToOmit: Set<string> = new Set()): RolePermissionSetsAddInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('RolePermissionSetsAddInput');
    return {
        permissionSetIds: overrides && overrides.hasOwnProperty('permissionSetIds') ? overrides.permissionSetIds! : [generateMockValue.uuid()],
        roleId: overrides && overrides.hasOwnProperty('roleId') ? overrides.roleId! : generateMockValue.uuid(),
    };
...
export const mockRolePermissionSetsAddPayload = (overrides?: Partial<RolePermissionSetsAddPayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'RolePermissionSetsAddPayload' } & RolePermissionSetsAddPayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('RolePermissionSetsAddPayload');
    return {
...
export const mockRolePermissionSetsRemoveInput = (overrides?: Partial<RolePermissionSetsRemoveInput>, _relationshipsToOmit: Set<string> = new Set()): RolePermissionSetsRemoveInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('RolePermissionSetsRemoveInput');
    return {
        permissionSetIds: overrides && overrides.hasOwnProperty('permissionSetIds') ? overrides.permissionSetIds! : [generateMockValue.uuid()],
        roleId: overrides && overrides.hasOwnProperty('roleId') ? overrides.roleId! : generateMockValue.uuid(),
    };
...
export const mockRolePermissionSetsRemovePayload = (overrides?: Partial<RolePermissionSetsRemovePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'RolePermissionSetsRemovePayload' } & RolePermissionSetsRemovePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('RolePermissionSetsRemovePayload');
    return {
...
export const mockRolesSort = (overrides?: Partial<RolesSort>, _relationshipsToOmit: Set<string> = new Set()): RolesSort => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('RolesSort');
    return {
        by: overrides && overrides.hasOwnProperty('by') ? overrides.by! : RolesSortBy.CreatedAt,
        direction: overrides && overrides.hasOwnProperty('direction') ? overrides.direction! : SortDirection.Asc,
    };
};

export const mockSelfCustodyConfigInput = (overrides?: Partial<SelfCustodyConfigInput>, _relationshipsToOmit: Set<string> = new Set()): SelfCustodyConfigInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('SelfCustodyConfigInput');
    return {
...
export const mockSubscription = (overrides?: Partial<Subscription>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Subscription' } & Subscription => {
    ...
    return {
        ...
        creditFacilityProposalUpdated: overrides && overrides.hasOwnProperty('creditFacilityProposalUpdated') ? overrides.creditFacilityProposalUpdated! : relationshipsToOmit.has('CreditFacilityProposal') ? {} as CreditFacilityProposal : mockCreditFacilityProposal({}, relationshipsToOmit),
        creditFacilityUpdated: overrides && overrides.hasOwnProperty('creditFacilityUpdated') ? overrides.creditFacilityUpdated! : relationshipsToOmit.has('CreditFacility') ? {} as CreditFacility : mockCreditFacility({}, relationshipsToOmit),
        disbursalUpdated: overrides && overrides.hasOwnProperty('disbursalUpdated') ? overrides.disbursalUpdated! : relationshipsToOmit.has('CreditFacilityDisbursal') ? {} as CreditFacilityDisbursal : mockCreditFacilityDisbursal({}, relationshipsToOmit),
        ...
        pendingCreditFacilityUpdated: overrides && overrides.hasOwnProperty('pendingCreditFacilityUpdated') ? overrides.pendingCreditFacilityUpdated! : relationshipsToOmit.has('PendingCreditFacility') ? {} as PendingCreditFacility : mockPendingCreditFacility({}, relationshipsToOmit),
        prospectUpdated: overrides && overrides.hasOwnProperty('prospectUpdated') ? overrides.prospectUpdated! : relationshipsToOmit.has('Prospect') ? {} as Prospect : mockProspect({}, relationshipsToOmit),
        ...
        withdrawalUpdated: overrides && overrides.hasOwnProperty('withdrawalUpdated') ? overrides.withdrawalUpdated! : relationshipsToOmit.has('Withdrawal') ? {} as Withdrawal : mockWithdrawal({}, relationshipsToOmit),
    };
};
...
export const mockTime = (overrides?: Partial<Time>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Time' } & Time => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('Time');
    return {
        __typename: 'Time',
        canAdvanceToNextEndOfDay: overrides && overrides.hasOwnProperty('canAdvanceToNextEndOfDay') ? overrides.canAdvanceToNextEndOfDay! : faker.datatype.boolean(),
...
export const mockTimeAdvanceToNextEndOfDayPayload = (overrides?: Partial<TimeAdvanceToNextEndOfDayPayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'TimeAdvanceToNextEndOfDayPayload' } & TimeAdvanceToNextEndOfDayPayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('TimeAdvanceToNextEndOfDayPayload');
    return {
...
export const mockUserConnection = (overrides?: Partial<UserConnection>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'UserConnection' } & UserConnection => {
    ...
    return {
        ...
        nodes: overrides && overrides.hasOwnProperty('nodes') ? overrides.nodes! : [relationshipsToOmit.has('User') ? {} as User : mockUser({}, relationshipsToOmit)],
        pageInfo: overrides && overrides.hasOwnProperty('pageInfo') ? overrides.pageInfo! : relationshipsToOmit.has('PageInfo') ? {} as PageInfo : mockPageInfo({}, relationshipsToOmit),
    };
};
...
export const mockUserRoleUpdateInput = (overrides?: Partial<UserRoleUpdateInput>, _relationshipsToOmit: Set<string> = new Set()): UserRoleUpdateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('UserRoleUpdateInput');
    return {
        roleId: overrides && overrides.hasOwnProperty('roleId') ? overrides.roleId! : generateMockValue.uuid(),
        userId: overrides && overrides.hasOwnProperty('userId') ? overrides.userId! : generateMockValue.uuid(),
    };
...
export const mockUserRoleUpdatePayload = (overrides?: Partial<UserRoleUpdatePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'UserRoleUpdatePayload' } & UserRoleUpdatePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('UserRoleUpdatePayload');
    return {
...
export const mockUsersSort = (overrides?: Partial<UsersSort>, _relationshipsToOmit: Set<string> = new Set()): UsersSort => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('UsersSort');
    return {
        by: overrides && overrides.hasOwnProperty('by') ? overrides.by! : UsersSortBy.CreatedAt,
        direction: overrides && overrides.hasOwnProperty('direction') ? overrides.direction! : SortDirection.Asc,
    };
};
...
export const mockWithdrawalsFilter = (overrides?: Partial<WithdrawalsFilter>, _relationshipsToOmit: Set<string> = new Set()): WithdrawalsFilter => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
