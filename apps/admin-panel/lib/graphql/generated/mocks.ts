...
export const mockQuery = (overrides?: Partial<Query>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Query' } & Query => {
    ...
    return {
        ...
        fiscalYearsForChart: overrides && overrides.hasOwnProperty('fiscalYearsForChart') ? overrides.fiscalYearsForChart! : relationshipsToOmit.has('FiscalYearConnection') ? {} as FiscalYearConnection : mockFiscalYearConnection({}, relationshipsToOmit),
