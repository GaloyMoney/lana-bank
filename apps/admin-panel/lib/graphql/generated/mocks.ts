...
export const mockDepositModuleConfig = (overrides?: Partial<DepositModuleConfig>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'DepositModuleConfig' } & DepositModuleConfig => {
    ...
    return {
        ...
        chartOfAccountForeignAgencyOrSubsidiaryDepositAccountsParentCode: overrides && overrides.hasOwnProperty('chartOfAccountForeignAgencyOrSubsidiaryDepositAccountsParentCode') ? overrides.chartOfAccountForeignAgencyOrSubsidiaryDepositAccountsParentCode! : faker.lorem.word(),
        ...
        chartOfAccountFrozenForeignAgencyOrSubsidiaryDepositAccountsParentCode: overrides && overrides.hasOwnProperty('chartOfAccountFrozenForeignAgencyOrSubsidiaryDepositAccountsParentCode') ? overrides.chartOfAccountFrozenForeignAgencyOrSubsidiaryDepositAccountsParentCode! : faker.lorem.word(),
