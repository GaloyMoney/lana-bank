...
export const mockCreditFacilityObligationAllocation = (overrides?: Partial<CreditFacilityObligationAllocation>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CreditFacilityObligationAllocation' } & CreditFacilityObligationAllocation => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CreditFacilityObligationAllocation');
    return {
        __typename: 'CreditFacilityObligationAllocation',
        amount: overrides && overrides.hasOwnProperty('amount') ? overrides.amount! : generateMockValue.usdCents(),
        createdAt: overrides && overrides.hasOwnProperty('createdAt') ? overrides.createdAt! : generateMockValue.timestamp(),
        creditFacility: overrides && overrides.hasOwnProperty('creditFacility') ? overrides.creditFacility! : relationshipsToOmit.has('CreditFacility') ? {} as CreditFacility : mockCreditFacility({}, relationshipsToOmit),
        id: overrides && overrides.hasOwnProperty('id') ? overrides.id! : faker.string.uuid(),
        obligationAllocationId: overrides && overrides.hasOwnProperty('obligationAllocationId') ? overrides.obligationAllocationId! : generateMockValue.uuid(),
    };
};
...
export const mockPaymentEntry = (overrides?: Partial<PaymentEntry>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'PaymentEntry' } & PaymentEntry => {
    ...
    return {
        ...
        payment: overrides && overrides.hasOwnProperty('payment') ? overrides.payment! : relationshipsToOmit.has('CreditFacilityObligationAllocation') ? {} as CreditFacilityObligationAllocation : mockCreditFacilityObligationAllocation({}, relationshipsToOmit),
        recordedAt: overrides && overrides.hasOwnProperty('recordedAt') ? overrides.recordedAt! : generateMockValue.timestamp(),
    };
};
