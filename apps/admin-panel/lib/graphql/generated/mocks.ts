...
export const mockSubscription = (overrides?: Partial<Subscription>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Subscription' } & Subscription => {
    ...
    return {
        ...
        creditFacilityCollateralizationUpdated: overrides && overrides.hasOwnProperty('creditFacilityCollateralizationUpdated') ? overrides.creditFacilityCollateralizationUpdated! : relationshipsToOmit.has('CreditFacilityCollateralizationUpdated') ? {} as CreditFacilityCollateralizationUpdated : mockCreditFacilityCollateralizationUpdated({}, relationshipsToOmit),
