...
export const mockQuery = (overrides?: Partial<Query>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Query' } & Query => {
    ...
    return {
        ...
        serverTime: overrides && overrides.hasOwnProperty('serverTime') ? overrides.serverTime! : relationshipsToOmit.has('ServerTime') ? {} as ServerTime : mockServerTime({}, relationshipsToOmit),
...
export const mockServerTime = (overrides?: Partial<ServerTime>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'ServerTime' } & ServerTime => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ServerTime');
    return {
        ...
        isArtificial: overrides && overrides.hasOwnProperty('isArtificial') ? overrides.isArtificial! : faker.datatype.boolean(),
    };
};
