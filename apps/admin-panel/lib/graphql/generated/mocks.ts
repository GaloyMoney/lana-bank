...
export const mockPublicRef = (overrides?: Partial<PublicRef>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'PublicRef' } & PublicRef => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PublicRef');
    return {
...
export const mockQuery = (overrides?: Partial<Query>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Query' } & Query => {
    ...
    return {
        ...
        publicRefLookup: overrides && overrides.hasOwnProperty('publicRefLookup') ? overrides.publicRefLookup! : relationshipsToOmit.has('PublicRef') ? {} as PublicRef : mockPublicRef({}, relationshipsToOmit),
