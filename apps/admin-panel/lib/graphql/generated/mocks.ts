...
export const mockEndOfDayEvent = (overrides?: Partial<EndOfDayEvent>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'EndOfDayEvent' } & EndOfDayEvent => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('EndOfDayEvent');
    return {
        __typename: 'EndOfDayEvent',
        completedAt: overrides && overrides.hasOwnProperty('completedAt') ? overrides.completedAt! : generateMockValue.timestamp(),
        ...
        previousDate: overrides && overrides.hasOwnProperty('previousDate') ? overrides.previousDate! : faker.date.past({ years: 1, refDate: new Date(2022, 0) }).toISOString(),
...
export const mockSubscription = (overrides?: Partial<Subscription>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Subscription' } & Subscription => {
    ...
    return {
        ...
        endOfDayCompleted: overrides && overrides.hasOwnProperty('endOfDayCompleted') ? overrides.endOfDayCompleted! : relationshipsToOmit.has('EndOfDayEvent') ? {} as EndOfDayEvent : mockEndOfDayEvent({}, relationshipsToOmit),
        ...
        timeUpdated: overrides && overrides.hasOwnProperty('timeUpdated') ? overrides.timeUpdated! : relationshipsToOmit.has('Time') ? {} as Time : mockTime({}, relationshipsToOmit),
