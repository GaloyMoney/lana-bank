...
export const mockAnnualClosingTransactionExecuteInput = (overrides?: Partial<AnnualClosingTransactionExecuteInput>, _relationshipsToOmit: Set<string> = new Set()): AnnualClosingTransactionExecuteInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('AnnualClosingTransactionExecuteInput');
    return {
        chartId: overrides && overrides.hasOwnProperty('chartId') ? overrides.chartId! : generateMockValue.uuid(),
    };
};

export const mockAnnualClosingTransactionExecutePayload = (overrides?: Partial<AnnualClosingTransactionExecutePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'AnnualClosingTransactionExecutePayload' } & AnnualClosingTransactionExecutePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('AnnualClosingTransactionExecutePayload');
    return {
        __typename: 'AnnualClosingTransactionExecutePayload',
        annualClosingTransaction: overrides && overrides.hasOwnProperty('annualClosingTransaction') ? overrides.annualClosingTransaction! : relationshipsToOmit.has('LedgerTransaction') ? {} as LedgerTransaction : mockLedgerTransaction({}, relationshipsToOmit),
    };
};
...
export const mockCreditFacilityProposalCollateralUpdateInput = (overrides?: Partial<CreditFacilityProposalCollateralUpdateInput>, _relationshipsToOmit: Set<string> = new Set()): CreditFacilityProposalCollateralUpdateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CreditFacilityProposalCollateralUpdateInput');
    return {
        collateral: overrides && overrides.hasOwnProperty('collateral') ? overrides.collateral! : generateMockValue.satoshis(),
        creditFacilityProposalId: overrides && overrides.hasOwnProperty('creditFacilityProposalId') ? overrides.creditFacilityProposalId! : generateMockValue.uuid(),
        effective: overrides && overrides.hasOwnProperty('effective') ? overrides.effective! : faker.date.past({ years: 1, refDate: new Date(2022, 0) }).toISOString(),
...
export const mockCreditFacilityProposalCollateralUpdatePayload = (overrides?: Partial<CreditFacilityProposalCollateralUpdatePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CreditFacilityProposalCollateralUpdatePayload' } & CreditFacilityProposalCollateralUpdatePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CreditFacilityProposalCollateralUpdatePayload');
    return {
...
export const mockLedgerAccount = (overrides?: Partial<LedgerAccount>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'LedgerAccount' } & LedgerAccount => {
    ...
    return {
        ...
        childrenWithCodeAndActivity: overrides && overrides.hasOwnProperty('childrenWithCodeAndActivity') ? overrides.childrenWithCodeAndActivity! : [relationshipsToOmit.has('LedgerAccount') ? {} as LedgerAccount : mockLedgerAccount({}, relationshipsToOmit)],
...
export const mockMutation = (overrides?: Partial<Mutation>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Mutation' } & Mutation => {
    ...
    return {
        ...
        annualClosingTransactionExecute: overrides && overrides.hasOwnProperty('annualClosingTransactionExecute') ? overrides.annualClosingTransactionExecute! : relationshipsToOmit.has('AnnualClosingTransactionExecutePayload') ? {} as AnnualClosingTransactionExecutePayload : mockAnnualClosingTransactionExecutePayload({}, relationshipsToOmit),
        ...
        creditFacilityProposalCollateralUpdate: overrides && overrides.hasOwnProperty('creditFacilityProposalCollateralUpdate') ? overrides.creditFacilityProposalCollateralUpdate! : relationshipsToOmit.has('CreditFacilityProposalCollateralUpdatePayload') ? {} as CreditFacilityProposalCollateralUpdatePayload : mockCreditFacilityProposalCollateralUpdatePayload({}, relationshipsToOmit),
