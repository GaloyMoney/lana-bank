...
export const mockLiquidationPaymentValue = (overrides?: Partial<LiquidationPaymentValue>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'LiquidationPaymentValue' } & LiquidationPaymentValue => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('LiquidationPaymentValue');
    return {
...
export const mockQuery = (overrides?: Partial<Query>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Query' } & Query => {
    ...
    return {
        ...
        liquidationPaymentCalculate: overrides && overrides.hasOwnProperty('liquidationPaymentCalculate') ? overrides.liquidationPaymentCalculate! : relationshipsToOmit.has('LiquidationPaymentValue') ? {} as LiquidationPaymentValue : mockLiquidationPaymentValue({}, relationshipsToOmit),
