    ...
    data: {
      customerByPublicId: {
        ...
        creditFacilities: [
          ...
          {
            __typename: "CreditFacility",
            id: "CreditFacility:cf-002",
            creditFacilityId: "cf-002",
            publicId: "CF-002",
            collateralizationState: CollateralizationState.UnderMarginCallThreshold,
            status: CreditFacilityStatus.Matured,
            activatedAt: "2023-12-01T09:00:00.000Z",
            balance: {
              __typename: "CreditFacilityBalance",
              collateral: {
                __typename: "CollateralBalance",
                btcBalance: 250_000_000,
              },
              outstanding: {
                __typename: "Outstanding",
                usdBalance: 2_500_000,
              },
            },
          },
        ],
...
type StoryProps = React.ComponentProps<typeof CustomerCreditFacilitiesPage> & {
...
export const Default: Story = {
  ...
  render: ({ params }) => (
    <CustomerLayout params={params}>
      <CustomerCreditFacilitiesPage params={params} />
    </CustomerLayout>
  ),
}
