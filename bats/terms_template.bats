...
@test "terms-template: can create" {
  ...
  terms_template_id=$(echo "$cli_output" | jq -r '.termsTemplateId // .termsId')
...
@test "terms-template: can update" {
  ...
  updated_id=$(echo "$cli_output" | jq -r '.termsTemplateId // .termsId')
...
@test "terms-template: can retrieve" {
  ...
  retrieved_id=$(echo "$cli_output" | jq -r '.termsTemplateId // .termsId')
