use admin_graphql_contracts::{TermValues, TermsInput};
use admin_graphql_custody::Custodian;
...
mutation_payload! { CreditFacilityProposalCreatePayload, credit_facility_proposal: CreditFacilityProposal }
...
mutation_payload! { CreditFacilityProposalCustomerApprovalConcludePayload, credit_facility_proposal: CreditFacilityProposal }
