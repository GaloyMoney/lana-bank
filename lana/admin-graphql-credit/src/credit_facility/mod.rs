...
use admin_graphql_contracts::TermValues;
use admin_graphql_custody::Wallet;
use admin_graphql_governance::ApprovalProcess;
use admin_graphql_shared::scalars::SortDirection;
use lana_app::terms::{CVLPct, CollateralizationState};
...
mutation_payload! { CreditFacilityPartialPaymentRecordPayload, credit_facility: CreditFacility }

#[derive(InputObject)]
pub struct CreditFacilityCompleteInput {
    pub credit_facility_id: UUID,
}
mutation_payload! { CreditFacilityCompletePayload, credit_facility: CreditFacility }
