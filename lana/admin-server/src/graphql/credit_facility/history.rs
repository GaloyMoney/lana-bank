...
pub enum CreditFacilityHistoryEntry {
    ...
    ReservedForLiquidation(CreditFacilityLiquidationProcessStarted),
}
...
#[derive(SimpleObject)]
pub struct CreditFacilityLiquidationProcessStarted {
    pub cents: UsdCents,
    pub recorded_at: Timestamp,
    pub effective: Date,
    pub tx_id: UUID,
...
impl From<lana_app::credit::LiquidationAmountReserved> for CreditFacilityLiquidationProcessStarted {
    fn from(liquidation: lana_app::credit::LiquidationAmountReserved) -> Self {
        Self {
