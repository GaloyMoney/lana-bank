...
pub struct DepositModuleConfig {
    ...
    chart_of_accounts_private_company_deposit_accounts_parent_code: Option<String>,
    chart_of_accounts_bank_deposit_accounts_parent_code: Option<String>,
    chart_of_accounts_financial_institution_deposit_accounts_parent_code: Option<String>,
    chart_of_accounts_non_domiciled_company_deposit_accounts_parent_code: Option<String>,
    ...
    chart_of_accounts_frozen_private_company_deposit_accounts_parent_code: Option<String>,
    chart_of_accounts_frozen_bank_deposit_accounts_parent_code: Option<String>,
    chart_of_accounts_frozen_financial_institution_deposit_accounts_parent_code: Option<String>,
    chart_of_accounts_frozen_non_domiciled_company_deposit_accounts_parent_code: Option<String>,
...
impl From<DomainChartOfAccountsIntegrationConfig> for DepositModuleConfig {
    fn from(values: DomainChartOfAccountsIntegrationConfig) -> Self {
        Self {
            ...
            chart_of_accounts_private_company_deposit_accounts_parent_code: Some(
                values
                    .chart_of_accounts_private_company_deposit_accounts_parent_code
                    .to_string(),
            ),
            chart_of_accounts_bank_deposit_accounts_parent_code: Some(
                values
                    .chart_of_accounts_bank_deposit_accounts_parent_code
                    .to_string(),
            ),
            chart_of_accounts_financial_institution_deposit_accounts_parent_code: Some(
                values
                    .chart_of_accounts_financial_institution_deposit_accounts_parent_code
                    .to_string(),
            ),
            chart_of_accounts_non_domiciled_company_deposit_accounts_parent_code: Some(
                values
            ...
            chart_of_accounts_frozen_private_company_deposit_accounts_parent_code: Some(
                values
                    .chart_of_accounts_frozen_private_company_deposit_accounts_parent_code
                    .to_string(),
            ),
            chart_of_accounts_frozen_bank_deposit_accounts_parent_code: Some(
                values
                    .chart_of_accounts_frozen_bank_deposit_accounts_parent_code
                    .to_string(),
            ),
            chart_of_accounts_frozen_financial_institution_deposit_accounts_parent_code: Some(
                values
                    .chart_of_accounts_frozen_financial_institution_deposit_accounts_parent_code
                    .to_string(),
            ),
            chart_of_accounts_frozen_non_domiciled_company_deposit_accounts_parent_code: Some(
                values
...
pub struct DepositModuleConfigureInput {
    ...
    pub chart_of_accounts_private_company_deposit_accounts_parent_code: String,
    pub chart_of_accounts_bank_deposit_accounts_parent_code: String,
    pub chart_of_accounts_financial_institution_deposit_accounts_parent_code: String,
    pub chart_of_accounts_non_domiciled_company_deposit_accounts_parent_code: String,
    ...
    pub chart_of_accounts_frozen_private_company_deposit_accounts_parent_code: String,
    pub chart_of_accounts_frozen_bank_deposit_accounts_parent_code: String,
