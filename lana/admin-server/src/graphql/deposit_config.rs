...
pub(super) use lana_app::deposit::ChartOfAccountsIntegrationConfig as DomainChartOfAccountsIntegrationConfig;

#[derive(SimpleObject, Clone)]
pub(super) struct DepositModuleConfig {
...
#[derive(InputObject)]
pub(super) struct DepositModuleConfigureInput {
