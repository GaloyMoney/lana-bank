...
use lana_app::primitives::{AccountSpec as DomainAccountSpec, AccountingBaseConfig, DebitOrCredit};
...
impl TryFrom<ChartOfAccountsAddRootNodeInput> for DomainAccountSpec {
