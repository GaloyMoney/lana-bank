...
struct DepositConfigData {
    ...
    non_domiciled_company_deposit_accounts_parent_code: String,
...
pub(in crate::accounting_init::seed) async fn deposit_module_configure(
    ...
    let DepositConfigData {
        ...
        non_domiciled_company_deposit_accounts_parent_code,
        ...
        frozen_non_domiciled_company_deposit_accounts_parent_code,
