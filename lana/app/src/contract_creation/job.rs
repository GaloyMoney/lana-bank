...
impl JobRunner for GenerateLoanAgreementJobRunner {
    async fn run(
        ...
        // TODO: In a full implementation, we would update a LoanAgreement entity here
        // For now, we'll create a simple completion record
        let _loan_agreement = CompletedLoanAgreement {
...
// Helper struct to track completed loan agreements
// In a full implementation, this would be a proper entity with event sourcing
#[derive(Debug, Clone)]
pub struct CompletedLoanAgreement {
    pub customer_id: CustomerId,
...
// Define the loan agreement entity types - these should be in a separate entity module
// but for now I'll put them here to get the pattern working

use derive_builder::Builder;

es_entity::entity_id! {
    LoanAgreementId;
    LoanAgreementId => job::JobId,
}
