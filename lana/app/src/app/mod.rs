    ...
    pub async fn init(
        ...
        let access = Access::init(
            ...
            &[
                ...
                core_customer::SUMSUB,
                core_credit::INTEREST_ACCRUAL,
                core_credit::COLLATERALIZATION_SYNC,
                core_credit::CREDIT_FACILITY_ACTIVATION,
                core_credit::PENDING_FACILITY_CREATION,
                core_credit::CREDIT_FACILITY_PAYMENT_ALLOCATION,
                core_credit::DISBURSAL_APPROVAL,
                core_credit::OBLIGATION_SYNC,
                core_deposit::DEPOSIT_APPROVAL,
                core_custody::CUSTODY_KEY_ROTATION,
                core_accounting::ACCOUNTING_TRIAL_BALANCE,
                governance::GOVERNANCE,
            ],
            &authz,
            &outbox,
