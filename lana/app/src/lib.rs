...
pub mod accounting {
    pub use core_accounting::{
        ...
        AccountingTemplateId, CalaAccountBalance, CalaAccountId, ChartId, CoreAccountingEvent,
        FiscalYearId, LedgerAccountId, TransactionTemplateId, accounting_templates,
