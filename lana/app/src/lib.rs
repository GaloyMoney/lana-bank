...
pub mod credit_facility {
    pub use core_credit::{
        ...
        CreditFacilitiesCursor, CreditFacilitiesSortBy, CreditFacility, CreditFacilityBalance,
        CreditFacilityConfig, CreditFacilityHistoryEntry, CreditFacilityOrigination,
