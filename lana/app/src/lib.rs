...
pub mod credit {
    ...
    pub use core_credit_collateral::{
        ...
        LiquidationPaymentAmounts, LiquidationsSortBy, liquidation_cursor,
...
pub mod time_events {
    ...
    /// Application-level time state that wraps the core struct and adds EOD status.
    #[derive(Clone, Debug)]
    pub struct TimeState {
        pub core: core_time_events::TimeState,
