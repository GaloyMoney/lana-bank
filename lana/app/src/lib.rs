...
pub mod customer {
    pub use core_customer::{
        AllowManualConversion, CUSTOMER_REF_TARGET, CoreCustomerEvent, Customer,
        CustomerConversion, CustomerDocumentId, CustomerId, CustomerStatus, CustomerType,
        CustomersCursor, CustomersFilters, CustomersSortBy, KycLevel, KycStatus,
        PROSPECT_REF_TARGET, Party, PartyId, PersonalInfo, Prospect, ProspectId, ProspectStage,
        ProspectsFilters, ProspectsSortBy, PublicProspect, Sort, error, prospect_cursor,
    };
    pub type Customers =
...
pub mod credit {
    ...
    pub use core_credit_collateral::{
        ...
        ManualCollateral, liquidation_cursor, liquidation_cursor::LiquidationsByIdCursor,
    };
...
pub mod report {
    pub use core_report::{
        ...
        ReportDefinitionOutput, ReportError, ReportFile, ReportId, ReportObject, ReportOutputFormat,
        ReportRun, ReportRunId, ReportRunState, ReportRunType, ReportRunsByCreatedAtCursor,
        ReportsByCreatedAtCursor, RequestedReport, error,
    };
    pub type Reports =
