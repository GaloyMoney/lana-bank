...
pub mod customer {
    pub use core_customer::{
        ...
        CustomersSortBy, KycLevel, KycStatus, ManuallyConverted, PROSPECT_REF_TARGET, Party,
        PartyId, PersonalInfo, Prospect, ProspectId, ProspectStage, ProspectsFilters,
        ProspectsSortBy, PublicProspect, RequireVerifiedCustomerForAccount, Sort, SumsubApproved,
