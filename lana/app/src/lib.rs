...
pub mod accounting {
    pub use core_accounting::{
        AccountCode, AccountCodeSection, AccountingCsvId, CalaAccountBalance, AccountingPeriodId, CalaAccountId,
        ChartId, LedgerAccountId, TransactionTemplateId, accounting_period, chart_of_accounts, csv,
        error, journal, ledger_account, ledger_transaction, manual_transaction,
        transaction_templates, {Chart, PeriodClosing, tree},
    };
...
pub mod terms {
    pub use core_credit::{
        ...
        ObligationDuration, OneTimeFeeRatePct, PendingCreditFacilityCollateralizationState,
        TermValues,
    };
}
