...
BEGIN
  ...
  IF event_type NOT IN ('initialized', 'kyc_started', 'kyc_approved', 'kyc_pending', 'kyc_on_hold', 'kyc_declined', 'manually_converted', 'verification_link_created', 'closed') THEN
