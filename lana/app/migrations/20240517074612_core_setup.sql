...
CREATE TABLE deposit_account_activity (
  deposit_account_id UUID PRIMARY KEY REFERENCES core_deposit_accounts(id),
  last_activity_date TIMESTAMPTZ NOT NULL
);

CREATE INDEX idx_deposit_account_activity_last_activity_date ON deposit_account_activity(last_activity_date);
