...
pub struct ExportWithdrawalToSumsubConfig {
    pub id: WithdrawalId,
    pub deposit_account_id: DepositAccountId,
    pub amount: UsdCents,
}

pub const EXPORT_WITHDRAWAL_TO_SUMSUB_COMMAND: JobType =
    JobType::new("command.deposit-sync.export-withdrawal-to-sumsub");

pub struct ExportWithdrawalToSumsubJobInitializer<Perms, E>
where
...
impl<Perms, E> ExportWithdrawalToSumsubJobInitializer<Perms, E>
where
    Perms: PermissionCheck,
    E: OutboxEventMarker<CoreDepositEvent>
        + OutboxEventMarker<CoreCustomerEvent>
...
impl<Perms, E> JobInitializer for ExportWithdrawalToSumsubJobInitializer<Perms, E>
where
    Perms: PermissionCheck,
    ...
    E: OutboxEventMarker<CoreDepositEvent>
        ...
        + std::fmt::Debug,
{
    type Config = ExportWithdrawalToSumsubConfig;

    fn job_type(&self) -> JobType {
        EXPORT_WITHDRAWAL_TO_SUMSUB_COMMAND
    }
    ...
    fn init(
        ...
        Ok(Box::new(ExportWithdrawalToSumsubJobRunner {
            config: job.config()?,
...
pub struct ExportWithdrawalToSumsubJobRunner<Perms, E>
where
    Perms: PermissionCheck,
    E: OutboxEventMarker<CoreDepositEvent>
        + OutboxEventMarker<CoreCustomerEvent>
        ...
        + std::fmt::Debug,
{
    config: ExportWithdrawalToSumsubConfig,
    sumsub_client: sumsub::SumsubClient,
    deposits: CoreDeposit<Perms, E>,
    customers: Customers<Perms, E>,
}
...
#[async_trait]
impl<Perms, E> JobRunner for ExportWithdrawalToSumsubJobRunner<Perms, E>
where
    Perms: PermissionCheck,
    <<Perms as PermissionCheck>::Audit as AuditSvc>::Action:
        From<CoreDepositAction> + From<CoreCustomerAction> + From<GovernanceAction>,
        ...
        + std::fmt::Debug,
{
    ...
    #[tracing::instrument(
        name = "deposit_sync.export_withdrawal_to_sumsub_job.process_command",
