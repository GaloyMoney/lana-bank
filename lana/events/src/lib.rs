...
pub use domain_configurations::DomainConfigurationEvent;
...
pub enum LanaEvent {
    ...
    DomainConfiguration(DomainConfigurationEvent),
}
...
impl_event_marker!(DomainConfigurationEvent, DomainConfiguration);
