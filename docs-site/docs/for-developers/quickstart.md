...
Use GraphQL introspection or browse the [Admin API Reference](../apis/admin-api/api-reference.mdx) to discover available operations.

## Next Steps

- [Admin API Reference](../apis/admin-api/api-reference.mdx) - Full API documentation
- [Customer API Reference](../apis/customer-api/api-reference.mdx) - Customer-facing operations
- [Domain Events](../apis/events/events.md) - Subscribe to system events
