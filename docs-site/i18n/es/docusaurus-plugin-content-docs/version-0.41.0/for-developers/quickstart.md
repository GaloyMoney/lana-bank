...
Usa la introspección de GraphQL o navega la [Referencia de API de Administración](../apis/admin-api/) para descubrir las operaciones disponibles.

## Siguientes Pasos

- [Referencia de API de Administración](../apis/admin-api/) - Documentación completa de la API
- [Referencia de API de Cliente](../apis/customer-api/) - Operaciones orientadas al cliente
- [Eventos de Dominio](../apis/events/) - Suscríbete a eventos del sistema
