...
![Garantía actualizada](/img/screenshots/current/en/credit-facilities.cy.ts/18_collateral_updated.png)
...
![Facilidad de crédito en lista](/img/screenshots/current/en/credit-facilities.cy.ts/22_credit_facility_in_list.png)
