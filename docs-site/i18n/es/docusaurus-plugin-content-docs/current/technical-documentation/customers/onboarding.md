...
graph TD
    subgraph S1["1. Creación de prospecto"]
        CREATE["El administrador crea prospecto<br/>(correo electrónico, tipo, ID de Telegram)"] --> PENDING["Registro de cliente creado<br/>KYC = Verificación pendiente<br/>Actividad = Inactivo"]
    end
    subgraph S2["2. Verificación KYC"]
        LINK["El operador genera<br/>enlace de verificación Sumsub"] --> CUST["El cliente completa<br/>verificación de identidad"] --> HOOK["Sumsub envía<br/>callback de webhook"]
    ...
    subgraph S3["3. Aprovisionamiento"]
        KYCBASIC --> KC["Usuario Keycloak creado<br/>(por evento outbox)"]
