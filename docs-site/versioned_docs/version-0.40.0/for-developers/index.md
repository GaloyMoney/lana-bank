...
|-----|---------|----------|
| **[Admin API](../apis/admin-api/api-reference.mdx)** | Full system management - customers, credit, accounting, configuration | Internal systems, back-office applications |
| **[Customer API](../apis/customer-api/api-reference.mdx)** | Customer-facing operations - account info, facility status | Customer portals, mobile apps |
...
Lana uses event sourcing. You can subscribe to [Domain Events](../apis/events/events.md) for real-time notifications of system changes.
...
- [Admin API Reference](../apis/admin-api/api-reference.mdx) - Full admin operations and types
- [Customer API Reference](../apis/customer-api/api-reference.mdx) - Customer-facing operations
- [Domain Events](../apis/events/events.md) - Event catalog and webhook integration
