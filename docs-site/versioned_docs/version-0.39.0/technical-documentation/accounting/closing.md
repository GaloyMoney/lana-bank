...
When calculating effective balances, the system considers the account's normal balance type. For credit-normal accounts, the effective balance is credits minus debits. For debit-normal accounts, it is debits minus credits. Effective balances can be negative.
